...
<p> 如下就是一种逻辑上的图结构：</p>
<p><img src="https://p.ipic.vip/7jm3eo.jpg" alt="逻辑上的图结构"></p>
...
<h3 id="无向图-有向图〔undirected-graph-deriected-graph〕" tabindex="-1"><a class="header-anchor" href="#无向图-有向图〔undirected-graph-deriected-graph〕" aria-hidden="true">#</a> 无向图 &amp; 有向图〔Undirected Graph &amp; Deriected Graph〕</h3>
<p>前面提到了二叉树完全可以实现其他树结构，类似地，有向图也完全可以实现无向图和混合图，因此有向图的研究一直是重点考察对象。</p>
...
<h3 id="有权图-无权图〔weighted-graph-unweighted-graph〕" tabindex="-1"><a class="header-anchor" href="#有权图-无权图〔weighted-graph-unweighted-graph〕" aria-hidden="true">#</a> 有权图 &amp; 无权图〔Weighted Graph &amp; Unweighted Graph〕</h3>
<p>如果边是有权重的是有权图（或者带权图），否则是无权图（或不带权图）。那么什么是有权重呢？比如汇率就是一种有权重的逻辑图。1 货币 A 兑换 5 货币 B，那么我们 A 和 B 的边的权重就是 5。而像朋友这种关系，就可以看做一种不带权的图。</p>
<h3 id="入度-出度〔indegree-outdegree〕" tabindex="-1"><a class="header-anchor" href="#入度-出度〔indegree-outdegree〕" aria-hidden="true">#</a> 入度 &amp; 出度〔Indegree &amp; Outdegree〕</h3>
<p>有多少边指向节点 A，那么节点 A 的入度就是多少。同样地，有多少边从 A 发出，那么节点 A 的出度就是多少。</p>
<p>仍然以上面的图为例，这幅图的所有节点的入度和出度都为 1。</p>
<p><img src="https://p.ipic.vip/r4js08.jpg" alt=""></p>
<h3 id="路径-环〔路径-path〕" tabindex="-1"><a class="header-anchor" href="#路径-环〔路径-path〕" aria-hidden="true">#</a> 路径 &amp; 环〔路径：Path〕</h3>
<ul>
...
<p><img src="https://p.ipic.vip/6suzbw.jpg" alt=""></p>
<h3 id="连通图-强连通图" tabindex="-1"><a class="header-anchor" href="#连通图-强连通图" aria-hidden="true">#</a> 连通图 &amp; 强连通图</h3>
<p>在无向图中，若<strong>任意两个顶点</strong> i 与 j 都有路径<strong>相通</strong>，则称该无向图为连通图。</p>
<p>在有向图中，若<strong>任意两个顶点</strong> i 与 j 都有路径<strong>相通</strong>，则称该有向图为强连通图。</p>
<h3 id="生成树" tabindex="-1"><a class="header-anchor" href="#生成树" aria-hidden="true">#</a> 生成树</h3>
<p>一个连通图的生成树是指一个连通子图，它含有图中全部 n 个顶点，但只有足以构成一棵树的 n-1 条边。一颗有 n 个顶点的生成树有且仅有 n-1 条边，如果生成树中再添加一条边，则必定成环。在连通网的所有生成树中，所有边的<strong>代价和最小</strong>的生成树，称为最小生成树，其中<strong>代价和</strong>指的是所有边的权重和。</p>
<h2 id="图的建立" tabindex="-1"><a class="header-anchor" href="#图的建立" aria-hidden="true">#</a> 图的建立</h2>
<p>一般图的题目都不会给你一个现成的图的数据结构。当你知道这是一个图的题目的时候，解题的第一步通常就是建图。</p>
...
<h3 id="邻接矩阵-常见-〔adjacency-matrixs〕" tabindex="-1"><a class="header-anchor" href="#邻接矩阵-常见-〔adjacency-matrixs〕" aria-hidden="true">#</a> 邻接矩阵（常见）〔Adjacency Matrixs〕</h3>
<p>第一种方式是使用数组或者哈希表来存储图，这里我们用二维数组来存储。</p>
...
<p><img src="https://p.ipic.vip/g6qhtl.jpg" alt=""></p>
...
<li>
<p>判断两个顶点是否连接，获取入度和出度以及更新度数，时间复杂度都是 O(1)</p>
</li>
</ol>
<p>由于使用起来比较简单， 因此我的所有的需要建图的题目基本都用这种方式。</p>
<p>比如力扣 743. 网络延迟时间。 题目描述：</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>有 N 个网络节点，标记为 1 到 N。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这是一个典型的图的题目，对于这道题，我们如何用邻接矩阵建图呢？</p>
<p>一个典型的建图代码：</p>
<p>使用哈希表构建邻接矩阵：</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>    graph <span class="token operator">=</span> collections<span class="token punctuation">.</span>defaultdict<span class="token punctuation">(</span><span class="token builtin">list</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这就构造了一个临界矩阵，之后我们基于这个邻接矩阵遍历图即可。</p>
<h3 id="邻接表〔adjacency-list〕" tabindex="-1"><a class="header-anchor" href="#邻接表〔adjacency-list〕" aria-hidden="true">#</a> 邻接表〔Adjacency List〕</h3>
<p>对于每个点，存储着一个链表，用来指向所有与该点直接相连的点。对于有权图来说，链表中元素值对应着权重。</p>
<p>例如在无向无权图中：</p>
<p><img src="https://p.ipic.vip/i1t6uf.jpg" alt="graph-1">
（图片来自 https://zhuanlan.zhihu.com/p/25498681）</p>
<p>可以看出在无向图中，邻接矩阵关于对角线对称，而邻接链表总有两条对称的边。</p>
<p>而在有向无权图中：</p>
<p><img src="https://p.ipic.vip/g1v1ts.jpg" alt="graph-2"></p>
<p>（图片来自 https://zhuanlan.zhihu.com/p/25498681）</p>
<p>由于邻接表使用起来稍微麻烦一点，另外也不常用。为了减少初学者的认知负担，我就不贴代码了。</p>
<h2 id="图的遍历" tabindex="-1"><a class="header-anchor" href="#图的遍历" aria-hidden="true">#</a> 图的遍历</h2>
<p>图建立好了，接下来就是要遍历了。</p>
...
<h3 id="深度优先遍历〔depth-first-search-dfs〕" tabindex="-1"><a class="header-anchor" href="#深度优先遍历〔depth-first-search-dfs〕" aria-hidden="true">#</a> 深度优先遍历〔Depth First Search, DFS〕</h3>
<p>深度优先遍历图的方法是，从图中某顶点 v 出发， 不断访问邻居， 邻居的邻居直到访问完毕。</p>
<p><img src="https://p.ipic.vip/fqq7k0.jpg" alt=""></p>
...
<p>广度优先搜索，可以被形象地描述为 &quot;浅尝辄止&quot;，它也需要一个队列以保持遍历过的顶点顺序，以便按出队的顺序再去访问这些顶点的邻接顶点。</p>
<p><img src="https://p.ipic.vip/eq4g1r.jpg" alt=""></p>
...
<h2 id="常见算法" tabindex="-1"><a class="header-anchor" href="#常见算法" aria-hidden="true">#</a> 常见算法</h2>
<p>图的题目的算法比较适合套模板。</p>
...
<p>强烈建议大家学习完专题篇的搜索之后再来学习下面经典算法。大家可以拿几道普通的搜索题目测试下，如果能够做出来再往下学习。推荐题目：<a href="https://leetcode-cn.com/problems/maximum-path-quality-of-a-graph/" title="最大化一张图中的路径价值" target="_blank" rel="noopener noreferrer">最大化一张图中的路径价值<ExternalLinkIcon/></a></p>
<h3 id="最短距离-最短路径" tabindex="-1"><a class="header-anchor" href="#最短距离-最短路径" aria-hidden="true">#</a> 最短距离，最短路径</h3>
<h4 id="dijkstra-算法" tabindex="-1"><a class="header-anchor" href="#dijkstra-算法" aria-hidden="true">#</a> Dijkstra 算法</h4>
<p>DIJKSTRA 基本思想是广度优先遍历。实际上搜索的最短路算法基本思想都是广度优先，只不过具体的扩展策略不同而已。</p>
...
<p>代码模板：</p>
<p>Python</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">import</span> heapq
...
<div class="language-JavaScript line-numbers-mode" data-ext="JavaScript"><pre v-pre class="language-JavaScript"><code>const dijkstra = (graph, start, end) =&gt; {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>会了这个算法模板， 你就可以去 AC 743. 网络延迟时间 了。</p>
<p>这里提供完整代码供大家参考：</p>
<p>Python</p>
...
<div class="language-JavaScript line-numbers-mode" data-ext="JavaScript"><pre v-pre class="language-JavaScript"><code>const networkDelayTime = (times, n, k) =&gt; {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>DJ 算法的时间复杂度为 $vlogv+e$，其中 v 和 e 分别为图中的点和边的个数。</p>
...
<h4 id="floyd-warshall-算法" tabindex="-1"><a class="header-anchor" href="#floyd-warshall-算法" aria-hidden="true">#</a> Floyd-Warshall 算法</h4>
<p>Floyd-Warshall 可以<strong>解决任意两个点距离</strong>，即多源最短路径，这点和 dj 算法不一样。</p>
...
<p><img src="https://p.ipic.vip/592ov2.jpg" alt=""></p>
...
<p>代码模板：</p>
<p>Python</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token comment"># graph 是邻接矩阵，n 是顶点个数</span>
...
<div class="language-JavaScript line-numbers-mode" data-ext="JavaScript"><pre v-pre class="language-JavaScript"><code>const floydWarshall = (graph, v)=&gt;{
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>我们回过头来看下如何套模板解决 力扣的 1462. 课程安排 IV，题目描述：</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>你总共需要上 n 门课，课程编号依次为 0 到 n-1 。
...
<div class="language-JavaScript line-numbers-mode" data-ext="JavaScript"><pre v-pre class="language-JavaScript"><code>//咳咳这个写法不是本题最优
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果这道题你可以解决了，我再推荐一道题给你 <a href="https://leetcode-cn.com/problems/count-subtrees-with-max-distance-between-cities/" title="1617. 统计子树中城市之间最大距离" target="_blank" rel="noopener noreferrer">1617. 统计子树中城市之间最大距离<ExternalLinkIcon/></a>，国际版有一个题解代码挺清晰，挺好理解的，只不过没有使用状态压缩性能不是很好罢了，地址：https://leetcode.com/problems/count-subtrees-with-max-distance-between-cities/discuss/1136596/Python-Floyd-Warshall-and-check-all-subtrees</p>
<p>图上的动态规划算法大家还可以拿这个题目来练习一下。</p>
<ul>
<li><a href="https://leetcode-cn.com/problems/cheapest-flights-within-k-stops/" title="787. K 站中转内最便宜的航班" target="_blank" rel="noopener noreferrer">787. K 站中转内最便宜的航班<ExternalLinkIcon/></a></li>
</ul>
<h4 id="贝尔曼-福特算法" tabindex="-1"><a class="header-anchor" href="#贝尔曼-福特算法" aria-hidden="true">#</a> 贝尔曼-福特算法</h4>
<p>和上面的算法类似。这种解法主要解决单源最短路径，即图中某一点到其他点的最短距离。</p>
<p>其基本思想也是动态规划。</p>
<p>核心算法为：</p>
<ul>
<li>初始化起点距离为 0</li>
...
<p><img src="https://p.ipic.vip/4909ju.jpg" alt=""></p>
<p>此算法时间复杂度：$O(V*E)$， 空间复杂度：$O(V)$。</p>
<p>代码示例：<br>
Python</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token comment"># return -1 for not exsit</span>
...
<div class="language-JavaScript line-numbers-mode" data-ext="JavaScript"><pre v-pre class="language-JavaScript"><code>const BellmanFord = (edges, startPoint)=&gt;{
...
<ul>
<li><a href="https://www.programiz.com/dsa/bellman-ford-algorithm" title="bellman-ford-algorithm" target="_blank" rel="noopener noreferrer">bellman-ford-algorithm<ExternalLinkIcon/></a></li>
</ul>
<p>题目推荐：</p>
<ul>
<li><a href="https://binarysearch.com/problems/Best-Currency-Path" title="Best Currency Path" target="_blank" rel="noopener noreferrer">Best Currency Path<ExternalLinkIcon/></a></li>
</ul>
<h3 id="拓扑排序" tabindex="-1"><a class="header-anchor" href="#拓扑排序" aria-hidden="true">#</a> 拓扑排序</h3>
<p>在计算机科学领域，有向图的拓扑排序是对其顶点的一种线性排序，使得对于从顶点 u 到顶点 v 的每个有向边 uv， u 在排序中都在之前。当且仅当图中没有定向环时（即有向无环图），才有可能进行拓扑排序。</p>
<p>典型的题目就是给你一堆课程，课程之间有先修关系，让你给出一种可行的学习路径方式，要求先修的课程要先学。任何有向无环图至少有一个拓扑排序。已知有算法可以在线性时间内，构建任何有向无环图的拓扑排序。</p>
<h4 id="kahn-算法" tabindex="-1"><a class="header-anchor" href="#kahn-算法" aria-hidden="true">#</a> Kahn 算法</h4>
<p>简单来说，假设 L 是存放结果的列表，先找到那些入度为零的节点，把这些节点放到 L 中，因为这些节点没有任何的父节点。**然后把与这些节点相连的边从图中去掉，再寻找图中的入度为零的节点。**对于新找到的这些入度为零的节点来说，他们的父节点已经都在 L 中了，所以也可以放入 L。重复上述操作，直到找不到入度为零的节点。如果此时 L 中的元素个数和节点总数相同，说明排序完成；如果 L 中的元素个数和节点总数不同，说明原图中存在环，无法进行拓扑排序。</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">def</span> <span class="token function">topologicalSort</span><span class="token punctuation">(</span>graph<span class="token punctuation">)</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="最小生成树" tabindex="-1"><a class="header-anchor" href="#最小生成树" aria-hidden="true">#</a> 最小生成树</h3>
<p>首先我们来看下什么是生成树。</p>
<p>首先生成树是原图的一个子图，它本质是一棵树，这也是为什么叫做生成树，而不是生成图的原因。其次生成树应该包括图中所有的顶点。 如下图由于没有包含所有顶点，换句话说所有顶点没有在同一个联通域，因此不是一个生成树。</p>
<p><img src="https://p.ipic.vip/9qlhgv.jpg" alt=""></p>
<blockquote>
<p>黄色顶点没有包括在内</p>
</blockquote>
<p>你可以将生成树看成是根节点不确定的多叉树，由于是一棵树，那么一定不包含环。如下图就不是生成树。</p>
<p><img src="https://p.ipic.vip/js111h.jpg" alt=""></p>
...
<p><img src="https://p.ipic.vip/bedy0j.jpg" alt=""></p>
<p>（图来自维基百科）</p>
<p>不难看出，计算最小生成树就是从边集合中挑选 n - 1 个边，使得其满足生成树，并且权值和最小。</p>
<p>Kruskal 和 Prim 是两个经典的求最小生成树的算法，这两个算法又是如何计算最小生成树的呢？本节我们就来了解一下它们。</p>
<h4 id="kruskal" tabindex="-1"><a class="header-anchor" href="#kruskal" aria-hidden="true">#</a> Kruskal</h4>
<p>Kruskal 相对比较容易理解，推荐掌握。</p>
...
<p>代码模板：</p>
<p>其中 edge 是一个数组，数组每一项都形如： (cost, fr, to)，含义是 从 fr 到 to 有一条权值为 cost 的边。</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">class</span> <span class="token class-name">DisjointSetUnion</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="prim" tabindex="-1"><a class="header-anchor" href="#prim" aria-hidden="true">#</a> Prim</h4>
<p>Prim 算法也被形象地称为<strong>加点法</strong>，每前进一次都选择权重最小的点，加入到结果集。形象地看就像一个不断生长的真实世界的树。</p>
<p>Prim 具体算法：</p>
<ol>
<li>初始化最小生成树点集 MV 为图中任意一个顶点，最小生成树边集 ME 为空。我们的目标是将 MV 填充到 和 V 一样，而边集则根据 MV 的产生自动计算。</li>
<li>在集合 E 中 （集合 E 为原始图的边集）选取最小的边 &lt;u, v&gt; 其中 u 为 MV 中已有的元素，而 v 为 MV 中不存在的元素（像不像上面说的<strong>不断生长的真实世界的树</strong>），将 v 加入到 MV，将 &lt;u, v&gt; 加到 ME。</li>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="两种算法比较" tabindex="-1"><a class="header-anchor" href="#两种算法比较" aria-hidden="true">#</a> 两种算法比较</h4>
<p>为了后面描述方便，我们令 V 为图中的顶点数， E 为图中的边数。那么 KruKal 的算法复杂度是 $O(ElogE)$，Prim 的算法时间复杂度为 $E + VlogV$。因此 Prim 适合适用于稠密图，而 KruKal 则适合稀疏图。</p>
<p>大家也可以参考一下 <a href="https://zh.wikipedia.org/wiki/%E6%9C%80%E5%B0%8F%E7%94%9F%E6%88%90%E6%A0%91" title="维基百科 - 最小生成树" target="_blank" rel="noopener noreferrer">维基百科 - 最小生成树<ExternalLinkIcon/></a> 的资料作为补充。</p>
<p>另外这里有一份视频学习资料，其中的动画做的不错，大家可以作为参考，地址：https://www.bilibili.com/video/BV1Eb41177d1/</p>
<p>大家可以使用 LeetCode 的 <a href="https://leetcode-cn.com/problems/min-cost-to-connect-all-points/" title="1584. 连接所有点的最小费用" target="_blank" rel="noopener noreferrer">1584. 连接所有点的最小费用<ExternalLinkIcon/></a> 来练习该算法。</p>
<h3 id="其他算法" tabindex="-1"><a class="header-anchor" href="#其他算法" aria-hidden="true">#</a> 其他算法</h3>
<h4 id="a-星寻路算法" tabindex="-1"><a class="header-anchor" href="#a-星寻路算法" aria-hidden="true">#</a> A 星寻路算法</h4>
<p>A 星寻路解决的问题是在一个二维的表格中找出任意两点的最短距离或者最短路径。常用于游戏中的 NPC 的移动计算，是一种常用启发式算法。一般这种题目都会有障碍物。除了障碍物，力扣的题目还会增加一些限制，使得题目难度增加。</p>
...
<ul>
<li>
<p>f(n) 是从初始状态经由状态 n 到目标状态的估计代价，</p>
</li>
<li>
<p>g(n) 是在状态空间中从初始状态到状态 n 的实际代价，</p>
</li>
<li>
<p>h(n) 是从状态 n 到目标状态的最佳路径的估计代价。</p>
</li>
</ul>
<p>如果 g(n)为 0，即只计算任意顶点 n 到目标的评估函数 h(n)，而不计算起点到顶点 n 的距离，则算法转化为使用贪心策略的最良优先搜索，速度最快，但可能得不出最优解；
如果 h(n)不大于顶点 n 到目标顶点的实际距离，则一定可以求出最优解，而且 h(n)越小，需要计算的节点越多，算法效率越低，常见的评估函数有——欧几里得距离、曼哈顿距离、切比雪夫距离；
如果 h(n)为 0，即只需求出起点到任意顶点 n 的最短路径 g(n)，而不计算任何评估函数 h(n)，则转化为单源最短路径问题，即 Dijkstra 算法，此时需要计算最多的顶点；</p>
<p>这里有一个重要的概念是<strong>估价算法</strong>，一般我们使用 <strong>曼哈顿距离</strong>来进行估价，即 <code v-pre>H(n) = D * (abs ( n.x – goal.x ) + abs ( n.y – goal.y ) )</code>。</p>
<p><img src="https://p.ipic.vip/wlg8gk.gif" alt=""></p>
<p>（图来自维基百科 https://zh.wikipedia.org/wiki/A*%E6%90%9C%E5%B0%8B%E6%BC%94%E7%AE%97%E6%B3%95 ）</p>
<p>一个完整的代码模板：</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code>grid <span class="token operator">=</span> <span class="token punctuation">[</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>典型题目<a href="https://leetcode-cn.com/problems/minimum-moves-to-move-a-box-to-their-target-location/" title="1263. 推箱子" target="_blank" rel="noopener noreferrer">1263. 推箱子<ExternalLinkIcon/></a></p>
<h4 id="二分图" tabindex="-1"><a class="header-anchor" href="#二分图" aria-hidden="true">#</a> 二分图</h4>
<p>二分图我在这两道题中讲过了，大家看一下之后把这两道题做一下就行了。其实这两道题和一道题没啥区别。</p>
<ul>
<li><a href="https://leetcode-solution-leetcode-pp.gitbook.io/leetcode-solution/medium/886.possible-bipartition" title="0886. 可能的二分法" target="_blank" rel="noopener noreferrer">0886. 可能的二分法<ExternalLinkIcon/></a></li>
<li><a href="https://leetcode-solution-leetcode-pp.gitbook.io/leetcode-solution/medium/785.is-graph-bipartite" title="0785. 判断二分图" target="_blank" rel="noopener noreferrer">0785. 判断二分图<ExternalLinkIcon/></a></li>
</ul>
<p>推荐顺序为： 先看 886 再看 785。</p>
<h2 id="总结" tabindex="-1"><a class="header-anchor" href="#总结" aria-hidden="true">#</a> 总结</h2>
<p>理解图的常见概念，我们就算入门了。接下来，我们就可以做题了。</p>
...
<li>而对于动态规划题目，一个经典的例子就是<strong>Floyd-Warshall 算法</strong>，理解好了之后大家不妨拿 <code v-pre>787. K 站中转内最便宜的航班</code> 练习一下。当然这要求大家应该先学习动态规划，关于动态规划，我们会在后面的《动态规划》以及《背包问题》中进行深度讲解。</li>
</ul>
<p> 常见的图的板子题有以下几种：</p>
<ol>
