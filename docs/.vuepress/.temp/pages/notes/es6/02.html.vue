<template><div><h1 id="_02-【let和const】" tabindex="-1"><a class="header-anchor" href="#_02-【let和const】" aria-hidden="true">#</a> 02 【let和const】</h1>
<h2 id="_1-let-命令" tabindex="-1"><a class="header-anchor" href="#_1-let-命令" aria-hidden="true">#</a> 1.let 命令</h2>
<h3 id="_1-1-基本用法" tabindex="-1"><a class="header-anchor" href="#_1-1-基本用法" aria-hidden="true">#</a> 1.1 基本用法</h3>
<p>ES6 新增了<code v-pre>let</code>命令，用来声明变量。它的用法类似于<code v-pre>var</code>，但是所声明的变量，只在<code v-pre>let</code>命令所在的代码块内有效。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面代码在代码块之中，分别用<code v-pre>let</code>和<code v-pre>var</code>声明了两个变量。然后在代码块之外调用这两个变量，结果<code v-pre>let</code>声明的变量报错，<code v-pre>var</code>声明的变量返回了正确的值。这表明，<code v-pre>let</code>声明的变量只在它所在的代码块有效。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面代码中，变量<code v-pre>i</code>是<code v-pre>var</code>命令声明的，在全局范围内都有效，所以全局只有一个变量<code v-pre>i</code>。每一次循环，变量<code v-pre>i</code>的值都会发生改变，而循环内被赋给数组<code v-pre>a</code>的函数内部的<code v-pre>console.log(i)</code>，里面的<code v-pre>i</code>指向的就是全局的<code v-pre>i</code>。也就是说，所有数组<code v-pre>a</code>的成员里面的<code v-pre>i</code>，指向的都是同一个<code v-pre>i</code>，导致运行时输出的是最后一轮的<code v-pre>i</code>的值，也就是 10。</p>
...
<span class="token comment">// abc</span>
<span class="token comment">// abc</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面代码正确运行，输出了 3 次<code v-pre>abc</code>。这表明函数内部的变量<code v-pre>i</code>与循环变量<code v-pre>i</code>不在同一个作用域，有各自单独的作用域（同一个作用域不可使用 <code v-pre>let</code> 重复声明同一个变量）。</p>
<h3 id="_1-2-不存在变量提升" tabindex="-1"><a class="header-anchor" href="#_1-2-不存在变量提升" aria-hidden="true">#</a> 1.2 不存在变量提升</h3>
...
<h3 id="_1-3-暂时性死区" tabindex="-1"><a class="header-anchor" href="#_1-3-暂时性死区" aria-hidden="true">#</a> 1.3 暂时性死区</h3>
<p>只要作用域内存在 let、const，它们所声明的变量或常量就自动 “绑定” 这个区域，不再受到外部作用域的影响。</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">let</span> a <span class="token operator">=</span> <span class="token number">2</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">let</span> a <span class="token operator">=</span> <span class="token number">2</span><span class="token punctuation">;</span>
<span class="token keyword">function</span> <span class="token function">func</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>a<span class="token punctuation">)</span><span class="token punctuation">;</span>        <span class="token comment">// 2</span>
<span class="token punctuation">}</span>
<span class="token function">func</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>即：只要作用域内出现了同名的 let 或 const，那么就会去找这个量（向前找），如果找不到也不会跳去外部找，只会直接报错！</strong></p>
<blockquote>
<p>只要我们遵守 “<strong>先声明后使用</strong>”，那么其实就基本不会遇到变量提升及暂时性死区问题。</p>
</blockquote>
<h3 id="_1-4-不允许重复声明" tabindex="-1"><a class="header-anchor" href="#_1-4-不允许重复声明" aria-hidden="true">#</a> 1.4 不允许重复声明</h3>
<p><code v-pre>let</code>不允许在相同作用域内，重复声明同一个变量。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-块级作用域" tabindex="-1"><a class="header-anchor" href="#_2-块级作用域" aria-hidden="true">#</a> 2.块级作用域</h2>
<h3 id="_2-1-为什么需要块级作用域" tabindex="-1"><a class="header-anchor" href="#_2-1-为什么需要块级作用域" aria-hidden="true">#</a> 2.1 为什么需要块级作用域？</h3>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>var s = 'hello';
...
<h3 id="_2-2-es6-的块级作用域" tabindex="-1"><a class="header-anchor" href="#_2-2-es6-的块级作用域" aria-hidden="true">#</a> 2.2 ES6 的块级作用域</h3>
...
<li>
<p>块级作用域：除了对象 <code v-pre>{}</code>，函数 <code v-pre>{}</code>（函数作用域）之外的一切 <code v-pre>{}</code> 都属于块级作用域。</p>
</li>
</ul>
...
<span class="token punctuation">{</span>
  ...
  <span class="token operator">...</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-3-块级作用域与函数声明" tabindex="-1"><a class="header-anchor" href="#_2-3-块级作用域与函数声明" aria-hidden="true">#</a> 2.3 块级作用域与函数声明</h3>
...
<span class="token keyword">if</span> <span class="token punctuation">(</span><span class="token boolean">true</span><span class="token punctuation">)</span>
  <span class="token keyword">function</span> <span class="token function">f</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span><span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-const-命令" tabindex="-1"><a class="header-anchor" href="#_3-const-命令" aria-hidden="true">#</a> 3.const 命令</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-2-本质" tabindex="-1"><a class="header-anchor" href="#_3-2-本质" aria-hidden="true">#</a> 3.2 本质</h3>
...
<h3 id="_3-3-window-对象的属性和方法-全局作用域中" tabindex="-1"><a class="header-anchor" href="#_3-3-window-对象的属性和方法-全局作用域中" aria-hidden="true">#</a> 3.3  window 对象的属性和方法（全局作用域中）</h3>
<p>全局作用域中，<code v-pre>var</code> 声明的变量，<code v-pre>function</code> 声明的函数，会自动变成 window 对象的属性或方法。</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> age <span class="token operator">=</span> <span class="token number">18</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">let</span> age <span class="token operator">=</span> <span class="token number">18</span><span class="token punctuation">;</span>
...
<h2 id="_4-let和const总结" tabindex="-1"><a class="header-anchor" href="#_4-let和const总结" aria-hidden="true">#</a> 4.let和const总结</h2>
<ol>
...
<h2 id="_5-顶层对象的属性" tabindex="-1"><a class="header-anchor" href="#_5-顶层对象的属性" aria-hidden="true">#</a> 5.顶层对象的属性</h2>
...
<p>ES6 为了改变这一点，一方面规定，为了保持兼容性，<code v-pre>var</code>命令和<code v-pre>function</code>命令声明的全局变量，依旧是顶层对象的属性；另一方面规定，<code v-pre>let</code>命令、<code v-pre>const</code>命令、<code v-pre>class</code>命令声明的全局变量，不属于顶层对象的属性。也就是说，从 ES6 开始，全局变量将逐步与顶层对象的属性脱钩。</p>
