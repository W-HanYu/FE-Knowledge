<template><div><h1 id="_6-函数-下" tabindex="-1"><a class="header-anchor" href="#_6-函数-下" aria-hidden="true">#</a> 6.函数（下）</h1>
<h2 id="_6-1-用new操作符调用函数" tabindex="-1"><a class="header-anchor" href="#_6-1-用new操作符调用函数" aria-hidden="true">#</a> 6.1 用new操作符调用函数</h2>
<p>现在，我们学习一种新的函数调用方式：<code v-pre>new 函数()</code></p>
<p>你可能知道 new 操作符和 “面向对象” 息息相关，但是现在我们先不探讨它的 “面向对象” 意义，而是先把用 new 调用函数的执行步骤和它上下文弄清楚。</p>
<h3 id="_6-1-1-用new调用函数的四步走" tabindex="-1"><a class="header-anchor" href="#_6-1-1-用new调用函数的四步走" aria-hidden="true">#</a> 6.1.1 用new调用函数的四步走</h3>
...
<h3 id="_6-1-2-四步走详解" tabindex="-1"><a class="header-anchor" href="#_6-1-2-四步走详解" aria-hidden="true">#</a> 6.1.2 四步走详解</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>【第一步：函数体内会自动创建出一个空白对象】</strong></p>
<p><img src="https://i0.hdslb.com/bfs/album/ff0b62fdc7a6e8989c73adea482e9d9e4656a586.png" alt=""></p>
<p><strong>【第二步：函数的上下文（this）会指向这个对象】</strong></p>
<p><img src="https://i0.hdslb.com/bfs/album/1e7346e5533f239cbf457ee686d08f24bb9ef97a.png" alt=""></p>
<p><strong>【第三步：执行函数体中的语句】</strong></p>
<blockquote>
<p>之后这个对象就不再是空对象了。</p>
</blockquote>
<p><img src="https://i0.hdslb.com/bfs/album/a12b06c4f4aab35ecb5f09cefecc8d19f6db9016.png" alt=""></p>
<p><strong>【第四步：函数会自动返回上下文对象，即使函数没有 return 语句】</strong></p>
<blockquote>
<p>执行结果为：{a: 3, b: 5}</p>
</blockquote>
<p><img src="https://i0.hdslb.com/bfs/album/5c2a93aff832c8dbefb66c427a347cc8e7b1e852.png" alt=""></p>
<p>【案例】</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">fun</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token keyword">this</span><span class="token punctuation">.</span>a <span class="token operator">=</span> <span class="token number">3</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-1-3-上下文规则总结" tabindex="-1"><a class="header-anchor" href="#_6-1-3-上下文规则总结" aria-hidden="true">#</a> 6.1.3 上下文规则总结</h3>
<table>
<thead>
<tr>
<th>规则</th>
...
<tr>
<td><code v-pre>DOM事件处理函数</code></td>
<td>绑定 DOM 的元素</td>
</tr>
<tr>
<td><code v-pre>call和apply</code></td>
<td>任意指定</td>
</tr>
<tr>
<td><code v-pre>用new调用函数</code></td>
<td>秘密创建出的对象</td>
</tr>
</tbody>
</table>
<h2 id="_6-2-构造函数" tabindex="-1"><a class="header-anchor" href="#_6-2-构造函数" aria-hidden="true">#</a> 6.2 构造函数</h2>
<p><img src="https://i0.hdslb.com/bfs/album/4ba104ec372c3827894f3e82cddbc9e7c5064105.png" alt="image-20220813220531771"></p>
<h3 id="_6-2-1-什么是构造函数" tabindex="-1"><a class="header-anchor" href="#_6-2-1-什么是构造函数" aria-hidden="true">#</a> 6.2.1 什么是构造函数</h3>
<p>构造函数是专门用来创建对象的函数<br>
<strong>一个构造函数我们也可以称为一个类</strong><br>
通过一个构造函数创建的对象，我们称该对象时这个构造函数的实例<br>
通过同一个构造函数创建的对象，我们称为一类对象<br>
构造函数就是一个普通的函数，只是他的调用方式不同，<br>
如果直接调用，它就是一个普通函数<br>
如果使用new来调用，则它就是一个构造函数</p>
<p>我们将之前书写的函数进行一下小改进：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 书写规范：构造函数首字母大写</span>
...
<li>顾名思义，构造函数用来 “构造新对象”，它内部的语句将为新对象添加若干属性和方法，完成对象的初始化</li>
<li>构造函数必须用 new 关键字调用，否则不能正常工作，正因如此，开发者约定构造函数命名时首字母要大写</li>
</ul>
<blockquote>
<p>注意：一个函数是不是构造函数，要看它是否用 new 调用，而至于名称首字母大写，完全是开发者的习惯约定。</p>
</blockquote>
<h3 id="_6-2-2-如果不用new调用构造函数" tabindex="-1"><a class="header-anchor" href="#_6-2-2-如果不用new调用构造函数" aria-hidden="true">#</a> 6.2.2 如果不用new调用构造函数</h3>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">People</span><span class="token punctuation">(</span><span class="token parameter">name<span class="token punctuation">,</span> age<span class="token punctuation">,</span> sex</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token keyword">this</span><span class="token punctuation">.</span>name <span class="token operator">=</span> name<span class="token punctuation">;</span>
    <span class="token keyword">this</span><span class="token punctuation">.</span>age <span class="token operator">=</span> age<span class="token punctuation">;</span>
    <span class="token keyword">this</span><span class="token punctuation">.</span>sex <span class="token operator">=</span> sex<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-2-3-为对象添加方法" tabindex="-1"><a class="header-anchor" href="#_6-2-3-为对象添加方法" aria-hidden="true">#</a> 6.2.3 为对象添加方法</h3>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">People</span><span class="token punctuation">(</span><span class="token parameter">name<span class="token punctuation">,</span> age<span class="token punctuation">,</span> sex</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token keyword">this</span><span class="token punctuation">.</span>name <span class="token operator">=</span> name<span class="token punctuation">;</span>
    <span class="token keyword">this</span><span class="token punctuation">.</span>age <span class="token operator">=</span> age<span class="token punctuation">;</span>
    <span class="token keyword">this</span><span class="token punctuation">.</span>sex <span class="token operator">=</span> sex<span class="token punctuation">;</span>
...
<p>注意：直接将方法写在构造函数中的方式是不妥的，后面会讲解原因。</p>
</blockquote>
<h2 id="_6-3-类与实例" tabindex="-1"><a class="header-anchor" href="#_6-3-类与实例" aria-hidden="true">#</a> 6.3 类与实例</h2>
<h3 id="_6-3-1-基本介绍" tabindex="-1"><a class="header-anchor" href="#_6-3-1-基本介绍" aria-hidden="true">#</a> 6.3.1 基本介绍</h3>
<p><img src="https://i0.hdslb.com/bfs/album/70020571a04b4bc0e622e9475451a275c516ebb7.png" alt=""></p>
<p>【类好比是 “蓝图”】</p>
<p>如同 “蓝图” 一样，类只描述对象会拥有哪些属性和方法，但是并不具体指明属性的值。</p>
<p>【实例是具体的对象】</p>
<p><img src="https://i0.hdslb.com/bfs/album/9716c6eeaccc1fd705a3d46c5180f02c68682a0c.png" alt=""></p>
<p>【构造函数和 “类”】</p>
<ul>
<li>Java、C++ 等是 <strong>“面向对象”</strong> 语言</li>
<li>JavaScript 是 <strong>“基于对象”</strong> 语言</li>
<li>JavaScript 中的构造函数可以类比于 OO 语言中的 “类”，写法的确类似，但和真正 OO语言 还是有本质不同，在后续课程还将看见 JS 和其他 OO 语言完全不同的、特有的原型特性。</li>
</ul>
<blockquote>
<p>JS 构造函数 ≈ OO 语言 “类”</p>
<p>JS 构造函数可以看做是面向对象语言中的 “类”</p>
</blockquote>
<h3 id="_6-3-2实例成员和静态成员" tabindex="-1"><a class="header-anchor" href="#_6-3-2实例成员和静态成员" aria-hidden="true">#</a> 6.3.2实例成员和静态成员</h3>
<p><img src="https://i0.hdslb.com/bfs/album/f584e1e793b649b653ede2d197dd501329b9c16c.png" alt="image-20220813220653492"></p>
<p><code v-pre>new</code>出来的实例对象就是构造函数内部的<code v-pre>this</code>
<strong>实例成员</strong>就是<code v-pre>this</code>后面的属性和方法</p>
<p><img src="https://i0.hdslb.com/bfs/album/a325098ff8a551375a8c415ac701110d24cda534.png" alt="image-20220813220700738"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://fastly.jsdelivr.net/gh/dselegent/picture_bed@master/img/202206071108258.png" alt="image-20220607110855302"></p>
<ul>
<li>实例成员的this指向实例对象</li>
<li>静态成员的this指向该构造函数本身</li>
</ul>
<h2 id="_6-4-原型-prototype" tabindex="-1"><a class="header-anchor" href="#_6-4-原型-prototype" aria-hidden="true">#</a> 6.4 原型(prototype)</h2>
<h3 id="_6-4-1-什么是prototype" tabindex="-1"><a class="header-anchor" href="#_6-4-1-什么是prototype" aria-hidden="true">#</a> 6.4.1 什么是prototype</h3>
<p><img src="https://i0.hdslb.com/bfs/album/e5fd09d5ce0a60b72bbbaddd66cd80da20655585.png" alt="image-20220813221457199"></p>
<p>任何函数都有 prototype 属性，prototype 是英语 “原型” 的意思。</p>
<p>prototype 属性值是个对象， 每个原型对象里面都有个constructor 属性（constructor 构造函数）
作用：该属性指向该原型对象的构造函数，</p>
<blockquote>
<p>constructor：制造商</p>
</blockquote>
<p><img src="https://i0.hdslb.com/bfs/album/5dcab9b97d368e39ac9961a0565bb00c6dcd26eb.png" alt=""></p>
...
true
*/</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>对于普通函数来说的 prototype 属性没有任何用处，而<strong>构造函数的 prototype 属性非常有用</strong>。</p>
<p><strong>构造函数的 prototype 属性是它的实例的原型</strong>。</p>
<p>所有的 JavaScript 对象都会从一个 prototype（原型对象）中继承属性和方法：</p>
<ul>
<li><code v-pre>Date</code> 对象从 <code v-pre>Date.prototype</code> 继承。</li>
<li><code v-pre>Array</code> 对象从 <code v-pre>Array.prototype</code> 继承。</li>
<li><code v-pre>Person</code> 对象从 <code v-pre>Person.prototype</code> 继承。</li>
</ul>
<p>所有 JavaScript 中的对象都是位于<strong>原型链顶端的 Object 的实例</strong>。</p>
<p>JavaScript 对象<strong>有一个指向一个原型对象的链。</strong></p>
<p>创建一个函数以后，<strong>解析器都会默认在函数中添加一个数prototype</strong></p>
<p>prototype属性指向的是一个对象，这个对象我们称为原型对象。</p>
<h3 id="_6-4-2-构造函数的prototype是实例的原型" tabindex="-1"><a class="header-anchor" href="#_6-4-2-构造函数的prototype是实例的原型" aria-hidden="true">#</a> 6.4.2 构造函数的prototype是实例的原型</h3>
<p>实例对象都会有一个属性 <strong>proto（对象原型）</strong> 指向构造函数的 prototype 原型对象，之所以我们对象可以使用构造函数 prototype  原型对象的属性和方法，就是因为对象有 <strong>proto</strong> 原型的存在。</p>
<p><img src="https://i0.hdslb.com/bfs/album/ac25c96779d412acc995d44627cf343ddf292e7d.png" alt="image-20220813221243209"></p>
<p><img src="https://i0.hdslb.com/bfs/album/8e0a7c2f2c79cb8ddf62ef05ff952f205043a668.png" alt="image-20220813221312823"></p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>这个隐含的属性可以通过对象<span class="token punctuation">.</span>__proto__来访问。  
__proto__ 属性：Chrome 提出的一个属性（<span class="token constant">W3C</span> 中没有）。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>原型对象就相当于一个公共的区域，凡是通过同一个构造函数创建的对象他们通常都可以访问到相同的原型对象。</strong></p>
<p>我们可以将对象中共有的属性和方法统一添加到原型对象中，<br>
这样我们只需要添加一次，就可以使所有的对象都可以使用。</p>
<p><img src="https://i0.hdslb.com/bfs/album/66ede9e0d5d993f7f79389586f6fcad0b14cfa25.png" alt=""></p>
<p><code v-pre>People.prototype</code> 是 <code v-pre>xiaoming</code> 的原型。</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">People</span><span class="token punctuation">(</span><span class="token parameter">name<span class="token punctuation">,</span> age<span class="token punctuation">,</span> sex</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token keyword">this</span><span class="token punctuation">.</span>name <span class="token operator">=</span> name<span class="token punctuation">;</span>
    <span class="token keyword">this</span><span class="token punctuation">.</span>age <span class="token operator">=</span> age<span class="token punctuation">;</span>
    <span class="token keyword">this</span><span class="token punctuation">.</span>sex <span class="token operator">=</span>sex<span class="token punctuation">;</span>
...
<p><img src="https://i0.hdslb.com/bfs/album/d4f262ab414729a22d06eabbb1e80761b97e623d.png" alt=""></p>
<h3 id="_6-4-3-原型链查找" tabindex="-1"><a class="header-anchor" href="#_6-4-3-原型链查找" aria-hidden="true">#</a> 6.4.3 原型链查找</h3>
<p>JavaScript 规定：实例可以 “打点” 访问<strong>它的原型的属性和方法</strong>，这被称为 “原型链查找”。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://i0.hdslb.com/bfs/album/df7e8cddd47cdda702a8cd2a76a4bb0c1f09470f.png" alt=""></p>
<p>【遮蔽效应】</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">People</span><span class="token punctuation">(</span><span class="token parameter">name<span class="token punctuation">,</span> age<span class="token punctuation">,</span> sex</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token keyword">this</span><span class="token punctuation">.</span>name <span class="token operator">=</span> name<span class="token punctuation">;</span>
    <span class="token keyword">this</span><span class="token punctuation">.</span>age <span class="token operator">=</span> age<span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://i0.hdslb.com/bfs/album/98a60557b04a3f053888a87731aa1b348ac1e4ed.png" alt=""></p>
<h3 id="_6-4-4-hasownproperty" tabindex="-1"><a class="header-anchor" href="#_6-4-4-hasownproperty" aria-hidden="true">#</a> 6.4.4 hasOwnProperty</h3>
<p>hasOwnProperty 方法可以检查对象是否真正 “自己拥有” 某属性或者方法。</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>xiaoming<span class="token punctuation">.</span><span class="token function">hasOwnProperty</span><span class="token punctuation">(</span><span class="token string">'name'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>		<span class="token comment">// true</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-4-5-in" tabindex="-1"><a class="header-anchor" href="#_6-4-5-in" aria-hidden="true">#</a> 6.4.5 in</h3>
<p>in 运算符只能检查某个属性或方法是否可以被对象访问，不能检查是否是自己的属性或方法。</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token string">'name'</span> <span class="token keyword">in</span> xiaoming			<span class="token comment">// true</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_6-5-原型-添加属性和方法" tabindex="-1"><a class="header-anchor" href="#_6-5-原型-添加属性和方法" aria-hidden="true">#</a> 6.5 原型-添加属性和方法</h2>
<h3 id="_6-5-1-为什么要写在原型上" tabindex="-1"><a class="header-anchor" href="#_6-5-1-为什么要写在原型上" aria-hidden="true">#</a> 6.5.1 为什么要写在原型上</h3>
<p>在之前的课程中，我们把方法都是直接添加到实例身上：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">People</span><span class="token punctuation">(</span><span class="token parameter">name<span class="token punctuation">,</span> age<span class="token punctuation">,</span> sex</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token keyword">this</span><span class="token punctuation">.</span>name <span class="token operator">=</span> name<span class="token punctuation">;</span>
    <span class="token keyword">this</span><span class="token punctuation">.</span>age <span class="token operator">=</span> age<span class="token punctuation">;</span>
    <span class="token keyword">this</span><span class="token punctuation">.</span>sex <span class="token operator">=</span> sex<span class="token punctuation">;</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://i0.hdslb.com/bfs/album/831abf9eef7eb688f58f7e98e49504d9df7a0d55.png" alt=""></p>
<p>把方法直接添加到实例身上的缺点：每个实例和每个实例的方法函数都是内存中不同的函数，造成了内存的浪费。</p>
<p>解决办法：将方法写到 prototype 上。</p>
<h3 id="_6-5-2-方法要写到-prototype-上" tabindex="-1"><a class="header-anchor" href="#_6-5-2-方法要写到-prototype-上" aria-hidden="true">#</a> 6.5.2 方法要写到 prototype 上</h3>
<p><strong>使用 prototype 属性</strong>就可以给<strong>对象的构造函数添加新的属性和方法</strong>。</p>
<p><img src="https://i0.hdslb.com/bfs/album/64e984e4c2492a6ede3cfdfab555d824400d3d81.png" alt="image-20220813214903427"></p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">People</span><span class="token punctuation">(</span><span class="token parameter">name<span class="token punctuation">,</span> age<span class="token punctuation">,</span> sex</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token keyword">this</span><span class="token punctuation">.</span>name <span class="token operator">=</span> name<span class="token punctuation">;</span>
    <span class="token keyword">this</span><span class="token punctuation">.</span>age <span class="token operator">=</span> age<span class="token punctuation">;</span>
    <span class="token keyword">this</span><span class="token punctuation">.</span>sex <span class="token operator">=</span>sex<span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>原型对象里面放的是方法, 这个方法里面的this 指向的是这个方法的调用者, 也就是这个实例对象。</strong></p>
<h2 id="_6-6-原型链" tabindex="-1"><a class="header-anchor" href="#_6-6-原型链" aria-hidden="true">#</a> 6.6 原型链</h2>
...
<p><img src="https://i0.hdslb.com/bfs/album/0f5a02019a1a67ab07e171d57ed6bbfd6ee780f4.png" alt=""></p>
<p><img src="https://i0.hdslb.com/bfs/album/1d3ece11ccf502dc5cade43c80f3bd65f96e87f2.png" alt="image-20220813221727150"></p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">People</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
<span class="token punctuation">}</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>查找规则</strong></p>
<p>① 当访问一个对象的属性（包括方法）时，首先查找这个对象自身有没有该属性。
② 如果没有就查找它的原型（也就是 __proto__指向的 prototype 原型对象）
③ 如果还没有就查找原型对象的原型（Object的原型对象）
④ 依此类推一直找到 Object 为止（null）
⑤ __proto__对象原型的意义就在于为实例对象查找机制提供一个方向，或者说一条路线</p>
<p>【关于数组的原型链】</p>
<p>任何数组实际上都是可以看做是 Array 这个构造函数 new 出来的。</p>
<p><img src="https://i0.hdslb.com/bfs/album/9a9238394188072ad1538b00e9e6718e01d6ba1c.png" alt=""></p>
<h2 id="_6-7-包装类" tabindex="-1"><a class="header-anchor" href="#_6-7-包装类" aria-hidden="true">#</a> 6.7 包装类</h2>
<h3 id="_6-7-1-定义" tabindex="-1"><a class="header-anchor" href="#_6-7-1-定义" aria-hidden="true">#</a> 6.7.1 定义</h3>
<ul>
<li>
<p>在JS中为我们提供了<strong>三个包装类：</strong><br>
String() Boolean() Number()<br>
通过这三个包装类可以创建基本数据类型的对象</p>
</li>
<li>
<p>很多编程语言都有 “包装类” 的设计，包装类的目的就是为了让基本类型值可以从它们的构造函数的 prototype 上获得方法</p>
</li>
<li>
<p>例子：</p>
...
<p><strong>在实际应用中千万不要这么干。</strong></p>
...
<h3 id="_6-7-2-举例" tabindex="-1"><a class="header-anchor" href="#_6-7-2-举例" aria-hidden="true">#</a> 6.7.2 举例</h3>
<p>请看下面的程序：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-7-3-实例方法" tabindex="-1"><a class="header-anchor" href="#_6-7-3-实例方法" aria-hidden="true">#</a> 6.7.3 实例方法</h3>
<p>三种包装对象各自提供了许多实例方法，详见后文。这里介绍两种它们共同具有、从<code v-pre>Object</code>对象继承的方法：<code v-pre>valueOf()</code>和<code v-pre>toString()</code>。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>toString</strong>()</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-7-4-自定义方法" tabindex="-1"><a class="header-anchor" href="#_6-7-4-自定义方法" aria-hidden="true">#</a> 6.7.4 自定义方法</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面代码在<code v-pre>String</code>和<code v-pre>Number</code>这两个对象的原型上面，分别自定义了一个方法，从而可以在所有实例对象上调用。注意，最后一行的<code v-pre>123</code>外面必须要加上圆括号，否则后面的点运算符（<code v-pre>.</code>）会被解释成小数点。</p>
<h3 id="_6-7-5-总结" tabindex="-1"><a class="header-anchor" href="#_6-7-5-总结" aria-hidden="true">#</a> 6.7.5 总结</h3>
<ul>
...
<blockquote>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> d <span class="token operator">=</span> <span class="token number">123</span><span class="token punctuation">;</span>
console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>d<span class="token punctuation">.</span>__proto__ <span class="token operator">==</span> <span class="token class-name">Number</span><span class="token punctuation">.</span>prototype<span class="token punctuation">)</span><span class="token punctuation">;</span>	<span class="token comment">// true</span>

<span class="token keyword">var</span> e <span class="token operator">=</span> <span class="token string">'慕课网'</span><span class="token punctuation">;</span>
console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>e<span class="token punctuation">.</span>__proto__ <span class="token operator">==</span> <span class="token class-name">String</span><span class="token punctuation">.</span>prototype<span class="token punctuation">)</span><span class="token punctuation">;</span>	<span class="token comment">// true</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>从以上代码可以看出，直接定义的基本变量本质也是 new 出来的，所以才可以直接打点调用相关方法。</p>
</blockquote>
<blockquote>
<p>注意：只有 Number()、String()、Boolean() 才是包装类， 而 Array() 不是数组的包装类，因为数组不是基本类型谈不上 “包装类” 这一说法的。</p>
</blockquote>
<h2 id="_6-8垃圾回收" tabindex="-1"><a class="header-anchor" href="#_6-8垃圾回收" aria-hidden="true">#</a> 6.8垃圾回收</h2>
<ol>
<li>
<p>什么是垃圾回收机制？</p>
<blockquote>
<p>垃圾回收机制(Garbage Collection) 简称 GC JS中内存的分配和回收都是自动完成的，内存在不使用的时候会被垃圾回收器自动回收。如果不了解JS的内存管理机制，我们同样非常容易成内存泄漏（内存无法被回收）的情况
（不再用到的内存，没有及时释放，就叫做内存泄漏）</p>
</blockquote>
</li>
<li>
<p>内存的生命周期</p>
...
<p>说明： 全局变量一般不会回收(关闭页面回收)； 一般情况下局部变量的值, 不用了, 会被自动回收掉</p>
</li>
</ol>
</blockquote>
</li>
</ol>
<p><img src="https://i0.hdslb.com/bfs/album/6001fefdb3790c27e45453e816c543c052df0c45.png" alt=""></p>
<p>就像人生活的时间长了会产生垃圾一样，程序运行过程中也会产生垃圾<br>
这些垃圾积攒过多以后，会导致程序运行的速度过慢，<br>
所以我们需要一个垃圾回收的机制，来处理程序运行过程中产生垃圾<br>
当一个对象没有任何的变量或属性对它进行引用，此时我们将永远无法操作该对象，<br>
此时这种对象就是一个垃圾，这种对象过多会占用大量的内存空间，导致程序运行变慢，<br>
所以这种垃圾必须进行清理。<br>
在JS中拥有自动的垃圾回收机制，会自动将这些垃圾对象从内存中销毁，<br>
我们不需要也不能进行垃圾回收的操作<br>
我们需要做的只是要将不再使在使用的变量设置为null</p>
<p><img src="https://i0.hdslb.com/bfs/album/7d958c8ac19f0934b06e9ddc69c28cd9d1af076c.png" alt="junk"></p>
<h2 id="_6-9-高阶函数-回调函数" tabindex="-1"><a class="header-anchor" href="#_6-9-高阶函数-回调函数" aria-hidden="true">#</a> 6.9 高阶函数-回调函数</h2>
<p><img src="https://i0.hdslb.com/bfs/album/7d719c343589e7d65d5d4de676e37cdda6be574d.png" alt="image-20220813143329567"></p>
<p><img src="https://i0.hdslb.com/bfs/album/7d719c343589e7d65d5d4de676e37cdda6be574d.png" alt="image-20220813143324854"></p>
<p>​	1. 函数表达式 ,函数也是【数据】,把函数赋值给变量</p>
<ol start="2">
<li>回调函数 , 把函数当做另外一个函数的参数传递，这个函数就叫回调函数 。回调函数本质还是函数，只不过把它当成参数使用 , 使用匿名函数做为回调函数比较常见。</li>
</ol>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>函数 <code v-pre>bar</code> 做参数传给了 <code v-pre>foo</code> 函数，<code v-pre>bar</code> 就是所谓的回调函数了！！！</p>
<p>我们回顾一下间歇函数 <code v-pre>setInterval</code></p>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span><span class="token punctuation">></span></span><span class="token script"><span class="token language-javascript">
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>fn</code> 函数做为参数传给了 <code v-pre>setInterval</code> ，这便是回调函数的实际应用了，结合刚刚学习的函数表达式上述代码还有另一种更常见写法。</p>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span><span class="token punctuation">></span></span><span class="token script"><span class="token language-javascript">
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>结论：</p>
<ol>
<li>回调函数本质还是函数，只不过把它当成参数使用</li>
<li>使用匿名函数做为回调函数比较常见</li>
</ol>
<h2 id="_6-10-高阶函数-闭包" tabindex="-1"><a class="header-anchor" href="#_6-10-高阶函数-闭包" aria-hidden="true">#</a> 6.10 高阶函数-闭包</h2>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 定义一个全局变量</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-10-1-什么是闭包" tabindex="-1"><a class="header-anchor" href="#_6-10-1-什么是闭包" aria-hidden="true">#</a> 6.10.1 什么是闭包</h3>
<p><img src="https://i0.hdslb.com/bfs/album/4032783dd84c99d73caca683a720a341c4214772.png" alt="3caca683a720a341c4214772"></p>
<p>闭包是函数本身和该函数声明时所处的环境状态的组合。</p>
<p>函数能够 “记忆” 其定义时所处的环境，<strong>即使函数不在其定义的环境中被调用，也能访问定义时所处环境的变量。</strong></p>
<p><strong>在 JS 中，每次创建函数时都会创建闭包。</strong></p>
<p><strong>但是，闭包特性往往需要将函数 “换一个地方” 执行，才能被直观的体现出来。</strong></p>
<p>闭包很有用，因为它允许我们将数据与操作该数据的函数关联起来，这与 “面向对象编程” 有少许相似之处。</p>
<p>闭包的功能：记忆性、模拟私有变量（相当于把函数的数据封装了）。</p>
<p><img src="https://i0.hdslb.com/bfs/album/c6bb35903d2b5a53aed8d0e33194aafa80d570f0.png" alt="image-20220814140242277"></p>
<h3 id="_6-10-2-闭包常见写法" tabindex="-1"><a class="header-anchor" href="#_6-10-2-闭包常见写法" aria-hidden="true">#</a> 6.10.2 闭包常见写法</h3>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>     简单的写法
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-10-3-闭包用途-记忆性" tabindex="-1"><a class="header-anchor" href="#_6-10-3-闭包用途-记忆性" aria-hidden="true">#</a> 6.10.3 闭包用途 - 记忆性</h3>
<p>当闭包产生时，函数所处环境的状态会始终保持在内存中，不会在外层函数调用后自动清除。这就是闭包的记忆性。</p>
<p>【闭包的记忆性举例】</p>
<p>创建体温检测函数 checkTemp(n)，可以检查体温 n 是否正常，函数会返回布尔值。</p>
<p>但是，不同的小区有不同的体温检测标准，比如 A 小区体温合格线是 37.1℃，而 B 小区体温合格线是 37.3℃，应该怎么编程呢？</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">createCheckTemp</span><span class="token punctuation">(</span><span class="token parameter">standardTemp</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>计数器案例</strong></p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>    <span class="token comment">// 闭包的应用 </span>
...
<h3 id="_6-11-3-使用闭包的注意点" tabindex="-1"><a class="header-anchor" href="#_6-11-3-使用闭包的注意点" aria-hidden="true">#</a> 6.11.3 使用闭包的注意点</h3>
<p>不能滥用闭包！否则会造成网页的性能问题，严重时可能导致 “内存泄漏”。</p>
<p>所谓 “内存泄漏” 就是指程序中已经动态分配的内存由于某种原因未释放或无法释放。</p>
<blockquote>
<p>目前，Chrome 等比较先进的浏览器很少发生内存泄漏。</p>
</blockquote>
<h3 id="_6-11-4-闭包面试题" tabindex="-1"><a class="header-anchor" href="#_6-11-4-闭包面试题" aria-hidden="true">#</a> 6.11.4 闭包面试题</h3>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">addCount</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_6-11-立即执行函数-iife" tabindex="-1"><a class="header-anchor" href="#_6-11-立即执行函数-iife" aria-hidden="true">#</a> 6.11 立即执行函数 IIFE</h2>
<h3 id="_6-11-1-形成-iife-的方法" tabindex="-1"><a class="header-anchor" href="#_6-11-1-形成-iife-的方法" aria-hidden="true">#</a> 6.11.1 形成 IIFE 的方法</h3>
<p>IIFE 立即调用函数表达式，是一种特殊的 JS 函数写法，函数定义完，立即被调用，这种函数叫做立即执行函数。<br>
立即执行函数往往只会执行一次</p>
<p><img src="https://i0.hdslb.com/bfs/album/a35092fff3de18a7505790d2e269d69c61946e01.png" alt=""></p>
<blockquote>
<p>蓝色括号里写传递的参数。</p>
</blockquote>
<p><img src="https://i0.hdslb.com/bfs/album/6122337cd59b2520666081a733b69d3356478ce7.png" alt=""></p>
<blockquote>
<p>常用 <code v-pre>()</code> 来将函数转为 “函数表达式”。</p>
</blockquote>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code>		<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span> <span class="token attr-name">type</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>text/javascript<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token script"><span class="token language-javascript">
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-11-2-iife的作用1-为变量赋值" tabindex="-1"><a class="header-anchor" href="#_6-11-2-iife的作用1-为变量赋值" aria-hidden="true">#</a> 6.11.2 IIFE的作用1 - 为变量赋值</h3>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> age <span class="token operator">=</span> <span class="token number">12</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-11-3-iife的作用2-将全局变量变为局部变量" tabindex="-1"><a class="header-anchor" href="#_6-11-3-iife的作用2-将全局变量变为局部变量" aria-hidden="true">#</a> 6.11.3 IIFE的作用2 - 将全局变量变为局部变量</h3>
<p>先看一个问题：</p>
...
*/</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>IIFE 可以在一些场合（如 for 循环中）将全局变量变为局部变量，语法显得紧凑。</p>
<blockquote>
<p>在 ES6 中，有更好的方式可以约定变量的作用域</p>
</blockquote>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> arr <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token punctuation">]</span><span class="token punctuation">;</span>
<span class="token keyword">for</span> <span class="token punctuation">(</span><span class="token keyword">var</span> i <span class="token operator">=</span> <span class="token number">0</span><span class="token punctuation">;</span> i <span class="token operator">&lt;</span> <span class="token number">5</span><span class="token punctuation">;</span> i<span class="token operator">++</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
