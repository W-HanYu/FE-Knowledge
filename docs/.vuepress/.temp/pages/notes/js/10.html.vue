<template><div><h1 id="_12-正则表达式" tabindex="-1"><a class="header-anchor" href="#_12-正则表达式" aria-hidden="true">#</a> 12.正则表达式</h1>
<h2 id="_12-1-什么是正则表达式" tabindex="-1"><a class="header-anchor" href="#_12-1-什么是正则表达式" aria-hidden="true">#</a> 12.1 什么是正则表达式</h2>
<p>正则表达式（regular expression）是一种表达文本模式（即字符串结构）的方法，有点像字符串的模板，常常用来按照“给定模式”匹配文本。</p>
<blockquote>
<p>比如：验证手机号、验证邮箱、验证身份证……</p>
</blockquote>
<h3 id="_12-1-1-快速感知正则表达式" tabindex="-1"><a class="header-anchor" href="#_12-1-1-快速感知正则表达式" aria-hidden="true">#</a> 12.1.1 快速感知正则表达式</h3>
<p>用一个例子快速演示正则表达式基本使用方法：检查某个字符串是否是 6 位数字。</p>
<p><img src="https://i0.hdslb.com/bfs/album/8078abc7f846e58388c282220840b6950b34f7a2.png" alt=""></p>
<h3 id="_12-1-2-正则表达式-按位-描述规则" tabindex="-1"><a class="header-anchor" href="#_12-1-2-正则表达式-按位-描述规则" aria-hidden="true">#</a> 12.1.2 正则表达式“按位”描述规则</h3>
<p>正则表达式“按位”描述规则，是指它是一位一位的描述字符串的构成形式。</p>
<p>比如检查字符串是不是这样的：以字母 m 开头，然后是 3 个数字，最后以字母 n 结尾。</p>
<p><img src="https://i0.hdslb.com/bfs/album/38f50c0c87e71751054dcc9e418a8a3c458e9a4b.png" alt=""></p>
<h2 id="_12-2-正则表达式的创建" tabindex="-1"><a class="header-anchor" href="#_12-2-正则表达式的创建" aria-hidden="true">#</a> 12.2 正则表达式的创建</h2>
<ul>
<li>使用 <code v-pre>/内容/</code> 的语法形式，可以快速创建正则表达式</li>
<li>也可以使用 <code v-pre>new RegExp('内容')</code> 的形式，创建正则表达式</li>
<li>使用 <code v-pre>typeof</code> 运算符检查正则表达式的类型，结果是 <code v-pre>object</code></li>
</ul>
<p>新建正则表达式有两种方法。一种是使用字面量，以斜杠表示开始和结束。</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>var regex = /xyz/;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>另一种是使用<code v-pre>RegExp</code>构造函数。</p>
...
<p>【修饰符的使用】</p>
<p><img src="https://i0.hdslb.com/bfs/album/ba274bb2b715f50781a4196c492803048408b00e.png" alt=""></p>
<h2 id="_12-3-正则对象的实例方法" tabindex="-1"><a class="header-anchor" href="#_12-3-正则对象的实例方法" aria-hidden="true">#</a> 12.3 正则对象的实例方法</h2>
<p>正则表达式可以“打点”调用哪些方法呢？</p>
<table>
<thead>
<tr>
<th>方法</th>
...
<td>根据正则表达式，在字符串中进行查找，返回结果数组或者 <code v-pre>null</code></td>
</tr>
</tbody>
</table>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>如果正则表达式带有<code v-pre>g</code>修饰符，则每一次<code v-pre>test</code>方法都从上一次结束的位置开始向后匹配。</p>
...
<p>注意，带有<code v-pre>g</code>修饰符时，正则表达式内部会记住上一次的<code v-pre>lastIndex</code>属性，这时不应该更换所要匹配的字符串，否则会有一些难以察觉的错误。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_12-3-2-regexp-prototype-exec" tabindex="-1"><a class="header-anchor" href="#_12-3-2-regexp-prototype-exec" aria-hidden="true">#</a> 12.3.2 RegExp.prototype.exec()</h3>
<p>正则实例对象的<code v-pre>exec()</code>方法，用来返回匹配结果。如果发现匹配，就返回一个数组，成员是匹配成功的子字符串，否则返回<code v-pre>null</code>。</p>
...
r1<span class="token punctuation">.</span><span class="token function">exec</span><span class="token punctuation">(</span>s<span class="token punctuation">)</span> <span class="token comment">// ["x"]</span>
...
<p>如果正则表示式包含圆括号（即含有“组匹配”），则返回的数组会包括多个成员。第一个成员是整个匹配成功的结果，后面的成员就是圆括号对应的匹配成功的组。也就是说，第二个成员对应第一个括号，第三个成员对应第二个括号，以此类推。整个数组的<code v-pre>length</code>属性等于组匹配的数量再加1。</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> s <span class="token operator">=</span> <span class="token string">'_x_x'</span><span class="token punctuation">;</span>
<span class="token keyword">var</span> r <span class="token operator">=</span> <span class="token regex"><span class="token regex-delimiter">/</span><span class="token regex-source language-regex">_(x)</span><span class="token regex-delimiter">/</span></span><span class="token punctuation">;</span>

r<span class="token punctuation">.</span><span class="token function">exec</span><span class="token punctuation">(</span>s<span class="token punctuation">)</span> <span class="token comment">// ["_x", "x"]</span>
...
<li><code v-pre>index</code>：模式匹配成功的开始位置（从0开始计数）。</li>
</ul>
...
arr <span class="token comment">// ["abbba", "bbb"]</span>

arr<span class="token punctuation">.</span>index <span class="token comment">// 1</span>
...
r1<span class="token punctuation">.</span>index <span class="token comment">// 0</span>
...
r2<span class="token punctuation">.</span>index <span class="token comment">// 4</span>
...
r3<span class="token punctuation">.</span>index <span class="token comment">// 8</span>
...
r4 <span class="token comment">// null</span>
...
<h2 id="_12-4-字符串的实例方法" tabindex="-1"><a class="header-anchor" href="#_12-4-字符串的实例方法" aria-hidden="true">#</a> 12.4 字符串的实例方法</h2>
...
<td>在字符串中根据正则表达式进行查找匹配，返回一个数组，成员是所有匹配的子字符串，找不到则返回 null</td>
</tr>
<tr>
...
<h3 id="_12-4-1-string-prototype-match" tabindex="-1"><a class="header-anchor" href="#_12-4-1-string-prototype-match" aria-hidden="true">#</a> 12.4.1 String.prototype.match()</h3>
<p>字符串实例对象的<code v-pre>match</code>方法对字符串进行正则匹配，返回匹配结果。</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> s <span class="token operator">=</span> <span class="token string">'_x_x'</span><span class="token punctuation">;</span>
<span class="token keyword">var</span> r1 <span class="token operator">=</span> <span class="token regex"><span class="token regex-delimiter">/</span><span class="token regex-source language-regex">x</span><span class="token regex-delimiter">/</span></span><span class="token punctuation">;</span>
<span class="token keyword">var</span> r2 <span class="token operator">=</span> <span class="token regex"><span class="token regex-delimiter">/</span><span class="token regex-source language-regex">y</span><span class="token regex-delimiter">/</span></span><span class="token punctuation">;</span>

s<span class="token punctuation">.</span><span class="token function">match</span><span class="token punctuation">(</span>r1<span class="token punctuation">)</span> <span class="token comment">// ["x"]</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>设置正则表达式的<code v-pre>lastIndex</code>属性，对<code v-pre>match</code>方法无效，匹配总是从字符串的第一个字符开始。</p>
...
<h3 id="_12-4-2-string-prototype-search" tabindex="-1"><a class="header-anchor" href="#_12-4-2-string-prototype-search" aria-hidden="true">#</a> 12.4.2 String.prototype.search()</h3>
<p>字符串对象的<code v-pre>search</code>方法，返回第一个满足条件的匹配结果在整个字符串中的位置。如果没有任何匹配，则返回<code v-pre>-1</code>。</p>
...
<h3 id="_12-4-3-string-prototype-replace" tabindex="-1"><a class="header-anchor" href="#_12-4-3-string-prototype-replace" aria-hidden="true">#</a> 12.4.3 String.prototype.replace()</h3>
<p>字符串对象的<code v-pre>replace</code>方法可以替换匹配的值。它接受两个参数，第一个是正则表达式，表示搜索模式，第二个是替换的内容。</p>
...
<span class="token string">'aaa'</span><span class="token punctuation">.</span><span class="token function">replace</span><span class="token punctuation">(</span><span class="token regex"><span class="token regex-delimiter">/</span><span class="token regex-source language-regex">a</span><span class="token regex-delimiter">/</span></span><span class="token punctuation">,</span> <span class="token string">'b'</span><span class="token punctuation">)</span> <span class="token comment">// "baa"</span>
<span class="token string">'aaa'</span><span class="token punctuation">.</span><span class="token function">replace</span><span class="token punctuation">(</span><span class="token regex"><span class="token regex-delimiter">/</span><span class="token regex-source language-regex">a</span><span class="token regex-delimiter">/</span><span class="token regex-flags">g</span></span><span class="token punctuation">,</span> <span class="token string">'b'</span><span class="token punctuation">)</span> <span class="token comment">// "bbb"</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面代码中，最后一个正则表达式使用了<code v-pre>g</code>修饰符，导致所有的<code v-pre>a</code>都被替换掉了。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>replace</code>方法的第二个参数可以使用美元符号<code v-pre>$</code>，用来指代所替换的内容。</p>
<ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面代码中，第一个例子是将匹配的组互换位置，第二个例子是改写匹配的值。</p>
<p><code v-pre>replace</code>方法的第二个参数还可以是一个函数，将每一个匹配内容替换为函数返回值。</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token string">'3 and 5'</span><span class="token punctuation">.</span><span class="token function">replace</span><span class="token punctuation">(</span><span class="token regex"><span class="token regex-delimiter">/</span><span class="token regex-source language-regex">[0-9]+</span><span class="token regex-delimiter">/</span><span class="token regex-flags">g</span></span><span class="token punctuation">,</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token parameter">match</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token keyword">return</span> <span class="token number">2</span> <span class="token operator">*</span> match<span class="token punctuation">;</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span>
...
<h3 id="_12-4-4-string-prototype-split" tabindex="-1"><a class="header-anchor" href="#_12-4-4-string-prototype-split" aria-hidden="true">#</a> 12.4.4 String.prototype.split()</h3>
<p>字符串对象的<code v-pre>split</code>方法按照正则规则分割字符串，返回一个由分割后的各个部分组成的数组。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>该方法接受两个参数，第一个参数是正则表达式，表示分隔规则，第二个参数是返回数组的最大成员数。</p>
...
<h2 id="_12-5-匹配规则" tabindex="-1"><a class="header-anchor" href="#_12-5-匹配规则" aria-hidden="true">#</a> 12.5 匹配规则</h2>
<h3 id="_12-5-1-字面量字符" tabindex="-1"><a class="header-anchor" href="#_12-5-1-字面量字符" aria-hidden="true">#</a> 12.5.1 字面量字符</h3>
<p>大部分字符在正则表达式中，就是字面的含义，比如<code v-pre>/a/</code>匹配<code v-pre>a</code>，<code v-pre>/b/</code>匹配<code v-pre>b</code>。如果在正则表达式之中，某个字符只表示它字面的含义（就像前面的<code v-pre>a</code>和<code v-pre>b</code>），那么它们就叫做“字面量字符”（literal characters）。</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token regex"><span class="token regex-delimiter">/</span><span class="token regex-source language-regex">dog</span><span class="token regex-delimiter">/</span></span><span class="token punctuation">.</span><span class="token function">test</span><span class="token punctuation">(</span><span class="token string">'old dog'</span><span class="token punctuation">)</span> <span class="token comment">// true</span>
...
<p>除了字面量字符以外，还有一部分字符有特殊含义，不代表字面的意思，它们叫做“元字符”（metacharacters）。</p>
<h3 id="_12-5-2-元字符" tabindex="-1"><a class="header-anchor" href="#_12-5-2-元字符" aria-hidden="true">#</a> 12.5.2 元字符</h3>
<p>“元字符”是指一位指定类型的字符。</p>
<blockquote>
<p><strong>元字符注意事项</strong></p>
<p>如果使用 <code v-pre>new RegExp()</code> 写法，反斜杆需要多写一个。</p>
<p>比如 <code v-pre>/^\d$/</code> 和 <code v-pre>new RegExp('^\\d$')</code> 是相同的意思。</p>
</blockquote>
<p><strong>（1）点字符（.)</strong></p>
<p>点字符（<code v-pre>.</code>）匹配除回车（<code v-pre>\r</code>）、换行(<code v-pre>\n</code>) 、行分隔符（<code v-pre>\u2028</code>）和段分隔符（<code v-pre>\u2029</code>）以外的所有字符。注意，对于码点大于<code v-pre>0xFFFF</code>字符，点字符不能正确匹配，会认为这是两个字符。</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token regex"><span class="token regex-delimiter">/</span><span class="token regex-source language-regex">c.t</span><span class="token regex-delimiter">/</span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>上面代码中，<code v-pre>c.t</code>匹配<code v-pre>c</code>和<code v-pre>t</code>之间包含任意一个字符的情况，只要这三个字符在同一行，比如<code v-pre>cat</code>、<code v-pre>c2t</code>、<code v-pre>c-t</code>等等，但是不匹配<code v-pre>coot</code>。</p>
<p><strong>（2）位置字符</strong></p>
<p>位置字符用来提示字符所处的位置，主要有两个字符。</p>
<ul>
<li><code v-pre>^</code> 表示字符串的开始位置</li>
<li><code v-pre>$</code> 表示字符串的结束位置</li>
</ul>
...
<span class="token comment">//这种表示是精准匹配</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>（3）选择符（<code v-pre>|</code>）</strong></p>
<p>竖线符号（<code v-pre>|</code>）在正则表达式中表示“或关系”（OR），即<code v-pre>cat|dog</code>表示匹配<code v-pre>cat</code>或<code v-pre>dog</code>。</p>
...
<h3 id="_12-5-3-字符的转义" tabindex="-1"><a class="header-anchor" href="#_12-5-3-字符的转义" aria-hidden="true">#</a> 12.5.3 字符的转义</h3>
<p>在特殊字符之前的反斜杠 <code v-pre>\</code> 表示下一个字符不是特殊字符，应该按照字面理解。</p>
<p>正则表达式中那些有特殊含义的元字符，如果要匹配它们本身，就需要在它们前面要加上反斜杠。比如要匹配<code v-pre>+</code>，就要写成<code v-pre>\+</code>。</p>
<ul>
<li><code v-pre>/^.$/</code>：检查字符串是不是任意字符</li>
<li><code v-pre>/^\.$/</code>：检查字符串是不是一个点</li>
<li><code v-pre>/^\\$/</code>：检查字符串是不是一个反斜杠</li>
</ul>
<p>不管一个符号有没有特殊意义，都可以在其之前加上一个 <code v-pre>\</code> 以确保它表达的是这个符号本身。</p>
...
<p>正则表达式中，需要反斜杠转义的，一共有12个字符：<code v-pre>^</code>、<code v-pre>.</code>、<code v-pre>[</code>、<code v-pre>$</code>、<code v-pre>(</code>、<code v-pre>)</code>、<code v-pre>|</code>、<code v-pre>*</code>、<code v-pre>+</code>、<code v-pre>?</code>、<code v-pre>{</code>和<code v-pre>\</code>。需要特别注意的是，如果使用<code v-pre>RegExp</code>方法生成正则对象，转义需要使用两个斜杠，因为字符串内部会先转义一次。</p>
...
<h3 id="_12-5-4-特殊字符" tabindex="-1"><a class="header-anchor" href="#_12-5-4-特殊字符" aria-hidden="true">#</a> 12.5.4 特殊字符</h3>
<p>正则表达式对一些不能打印的特殊字符，提供了表达方法。</p>
<ul>
<li><code v-pre>\cX</code> 表示<code v-pre>Ctrl-[X]</code>，其中的<code v-pre>X</code>是A-Z之中任一个英文字母，用来匹配控制字符。</li>
<li><code v-pre>[\b]</code> 匹配退格键(U+0008)，不要与<code v-pre>\b</code>混淆。</li>
<li><code v-pre>\n</code> 匹配换行键。</li>
<li><code v-pre>\r</code> 匹配回车键。</li>
<li><code v-pre>\t</code> 匹配制表符 tab（U+0009）。</li>
<li><code v-pre>\v</code> 匹配垂直制表符（U+000B）。</li>
<li><code v-pre>\f</code> 匹配换页符（U+000C）。</li>
<li><code v-pre>\0</code> 匹配<code v-pre>null</code>字符（U+0000）。</li>
<li><code v-pre>\xhh</code> 匹配一个以两位十六进制数（<code v-pre>\x00</code>-<code v-pre>\xFF</code>）表示的字符。</li>
<li><code v-pre>\uhhhh</code> 匹配一个以四位十六进制数（<code v-pre>\u0000</code>-<code v-pre>\uFFFF</code>）表示的 Unicode 字符。</li>
</ul>
<h3 id="_12-5-5-字符类" tabindex="-1"><a class="header-anchor" href="#_12-5-5-字符类" aria-hidden="true">#</a> 12.5.5 字符类</h3>
<p>字符类（class）表示有一系列字符可供选择，只要匹配其中一个就可以了。所有可供选择的字符都放在方括号内，比如<code v-pre>[xyz]</code> 表示<code v-pre>x</code>、<code v-pre>y</code>、<code v-pre>z</code>之中任选一个匹配。</p>
<p>比如某学校的学号规定：第1位是一个字母，b表示本科生，y表示研究生，后面是7位数字，用正则表达式表示为：</p>
<p><code v-pre>/^[by]\d{7}$/</code></p>
<p><strong>例</strong></p>
...
<p>有两个字符在字符类中有特殊含义。</p>
<p>可以使用短横 <code v-pre>-</code> 来指定一个字符范围，<code v-pre>^</code> 表示否定。</p>
<table>
<thead>
<tr>
<th>元字符</th>
...
<td><code v-pre>[A-Za-z0-9_]</code></td>
</tr>
<tr>
<td><code v-pre>\W</code></td>
<td><code v-pre>[^A-Za-z0-9_]</code></td>
...
<p>如果方括号内的第一个字符是<code v-pre>[^]</code>，则表示除了字符类之中的字符，其他字符都可以匹配。比如，<code v-pre>[^xyz]</code>表示除了<code v-pre>x</code>、<code v-pre>y</code>、<code v-pre>z</code>之外都可以匹配。</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token regex"><span class="token regex-delimiter">/</span><span class="token regex-source language-regex">[^abc]</span><span class="token regex-delimiter">/</span></span><span class="token punctuation">.</span><span class="token function">test</span><span class="token punctuation">(</span><span class="token string">'bbc news'</span><span class="token punctuation">)</span> <span class="token comment">// true</span>
...
<p>如果方括号内没有其他字符，即只有<code v-pre>[^]</code>，就表示匹配一切字符，其中包括换行符。相比之下，点号作为元字符（<code v-pre>.</code>）是不包括换行符的。</p>
...
<p>某些情况下，对于连续序列的字符，连字符（<code v-pre>-</code>）用来提供简写形式，表示字符的连续范围。比如，<code v-pre>[abc]</code>可以写成<code v-pre>[a-c]</code>，<code v-pre>[0123456789]</code>可以写成<code v-pre>[0-9]</code>，同理<code v-pre>[A-Z]</code>表示26个大写字母。</p>
...
<h3 id="_12-5-6-预定义模式" tabindex="-1"><a class="header-anchor" href="#_12-5-6-预定义模式" aria-hidden="true">#</a> 12.5.6 预定义模式</h3>
<p>预定义模式指的是某些常见模式的简写方式。</p>
<ul>
<li><code v-pre>\d</code> 匹配0-9之间的任一数字，相当于<code v-pre>[0-9]</code>。</li>
<li><code v-pre>\D</code> 匹配所有0-9以外的字符，相当于<code v-pre>[^0-9]</code>。</li>
<li><code v-pre>\w</code> 匹配任意的字母、数字和下划线，相当于<code v-pre>[A-Za-z0-9_]</code>。</li>
<li><code v-pre>\W</code> 除所有字母、数字和下划线以外的字符，相当于<code v-pre>[^A-Za-z0-9_]</code>。</li>
<li><code v-pre>\s</code> 匹配空格（包括换行符、制表符、空格符等），相等于<code v-pre>[ \t\r\n\v\f]</code>。</li>
<li><code v-pre>\S</code> 匹配非空格的字符，相当于<code v-pre>[^ \t\r\n\v\f]</code>。</li>
<li><code v-pre>\b</code> 匹配词的边界。</li>
<li><code v-pre>\B</code> 匹配非词边界，即在词的内部。</li>
</ul>
<p>下面是一些例子。</p>
...
<h3 id="_12-5-7-量词" tabindex="-1"><a class="header-anchor" href="#_12-5-7-量词" aria-hidden="true">#</a> 12.5.7 量词</h3>
<table>
<thead>
<tr>
<th>量词</th>
...
<td>匹配前一个表达式 0 次或多次。等价于 <code v-pre>{0, }</code></td>
</tr>
<tr>
<td><code v-pre>+</code></td>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token regex"><span class="token regex-delimiter">/</span><span class="token regex-source language-regex">lo{2}k</span><span class="token regex-delimiter">/</span></span><span class="token punctuation">.</span><span class="token function">test</span><span class="token punctuation">(</span><span class="token string">'look'</span><span class="token punctuation">)</span> <span class="token comment">// true</span>
<span class="token operator">/</span>lo<span class="token punctuation">{</span><span class="token number">2</span><span class="token punctuation">,</span><span class="token number">5</span><span class="token punctuation">}</span>k<span class="token operator">/</span><span class="token punctuation">.</span><span class="token function">test</span><span class="token punctuation">(</span><span class="token string">'looook'</span><span class="token punctuation">)</span> <span class="token comment">// true</span>
...
<p><strong>（2）量词符</strong></p>
<p>量词符用来设定某个模式出现的次数。</p>
<ul>
<li><code v-pre>?</code> 问号表示某个模式出现0次或1次，等同于<code v-pre>{0, 1}</code>。</li>
<li><code v-pre>*</code> 星号表示某个模式出现0次或多次，等同于<code v-pre>{0,}</code>。</li>
<li><code v-pre>+</code> 加号表示某个模式出现1次或多次，等同于<code v-pre>{1,}</code>。</li>
</ul>
...
<span class="token operator">/</span>t<span class="token operator">*</span>est<span class="token operator">/</span><span class="token punctuation">.</span><span class="token function">test</span><span class="token punctuation">(</span><span class="token string">'est'</span><span class="token punctuation">)</span> <span class="token comment">// true</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_12-5-8-贪婪模式" tabindex="-1"><a class="header-anchor" href="#_12-5-8-贪婪模式" aria-hidden="true">#</a> 12.5.8 贪婪模式</h3>
<p>之前的三个量词符，默认情况下都是最大可能匹配，即匹配到下一个字符不满足匹配规则为止。这被称为贪婪模式。</p>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>var s = 'aaa';
s.match(/a+?/) // ["a"]
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>上面例子中，模式结尾添加了一个问号<code v-pre>/a+?/</code>，这时就改为非贪婪模式，一旦条件满足，就不再往下匹配，<code v-pre>+?</code>表示只要发现一个<code v-pre>a</code>，就不再往下匹配了。</p>
<p>除了非贪婪模式的加号（<code v-pre>+?</code>），还有非贪婪模式的星号（<code v-pre>*?</code>）和非贪婪模式的问号（<code v-pre>??</code>）。</p>
<ul>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token string">'abb'</span><span class="token punctuation">.</span><span class="token function">match</span><span class="token punctuation">(</span><span class="token regex"><span class="token regex-delimiter">/</span><span class="token regex-source language-regex">ab*</span><span class="token regex-delimiter">/</span></span><span class="token punctuation">)</span> <span class="token comment">// ["abb"]</span>
<span class="token string">'abb'</span><span class="token punctuation">.</span><span class="token function">match</span><span class="token punctuation">(</span><span class="token regex"><span class="token regex-delimiter">/</span><span class="token regex-source language-regex">ab*?</span><span class="token regex-delimiter">/</span></span><span class="token punctuation">)</span> <span class="token comment">// ["a"]</span>

<span class="token string">'abb'</span><span class="token punctuation">.</span><span class="token function">match</span><span class="token punctuation">(</span><span class="token regex"><span class="token regex-delimiter">/</span><span class="token regex-source language-regex">ab?</span><span class="token regex-delimiter">/</span></span><span class="token punctuation">)</span> <span class="token comment">// ["ab"]</span>
<span class="token string">'abb'</span><span class="token punctuation">.</span><span class="token function">match</span><span class="token punctuation">(</span><span class="token regex"><span class="token regex-delimiter">/</span><span class="token regex-source language-regex">ab??</span><span class="token regex-delimiter">/</span></span><span class="token punctuation">)</span> <span class="token comment">// ["a"]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面例子中，<code v-pre>/ab*/</code>表示如果<code v-pre>a</code>后面有多个<code v-pre>b</code>，那么匹配尽可能多的<code v-pre>b</code>；<code v-pre>/ab*?/</code>表示匹配尽可能少的<code v-pre>b</code>，也就是0个<code v-pre>b</code>。</p>
<h3 id="_12-5-9-修饰符" tabindex="-1"><a class="header-anchor" href="#_12-5-9-修饰符" aria-hidden="true">#</a> 12.5.9 修饰符</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>（1）g 修饰符</strong></p>
