<template><div><h1 id="_15-错误处理机制" tabindex="-1"><a class="header-anchor" href="#_15-错误处理机制" aria-hidden="true">#</a> 15.错误处理机制</h1>
<p>错误处理机制是指预估代码执行过程中可能发生的错误，然后最大程度的避免错误的发生导致整个程序无法继续运行</p>
<h2 id="_15-1-error-实例对象" tabindex="-1"><a class="header-anchor" href="#_15-1-error-实例对象" aria-hidden="true">#</a> 15.1 Error 实例对象</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>上面代码中，我们调用<code v-pre>Error()</code>构造函数，生成一个实例对象<code v-pre>err</code>。<code v-pre>Error()</code>构造函数接受一个参数，表示错误提示，可以从实例的<code v-pre>message</code>属性读到这个参数。抛出<code v-pre>Error</code>实例对象以后，整个程序就中断在发生错误的地方，不再往下执行。</p>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">if</span> <span class="token punctuation">(</span>error<span class="token punctuation">.</span>name<span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>stack</code>属性用来查看错误发生时的堆栈。</p>
...
<h2 id="_15-2-原生错误类型" tabindex="-1"><a class="header-anchor" href="#_15-2-原生错误类型" aria-hidden="true">#</a> 15.2 原生错误类型</h2>
<p><code v-pre>Error</code>实例对象是最一般的错误类型，在它的基础上，JavaScript 还定义了其他6种错误对象。也就是说，存在<code v-pre>Error</code>的6个派生对象。</p>
<h3 id="_15-2-1-syntaxerror-对象" tabindex="-1"><a class="header-anchor" href="#_15-2-1-syntaxerror-对象" aria-hidden="true">#</a> 15.2.1 SyntaxError 对象</h3>
<p><code v-pre>SyntaxError</code>对象是解析代码时发生的语法错误。</p>
...
<h3 id="_15-2-2-referenceerror-对象" tabindex="-1"><a class="header-anchor" href="#_15-2-2-referenceerror-对象" aria-hidden="true">#</a> 15.2.2 ReferenceError 对象</h3>
<p><code v-pre>ReferenceError</code>对象是引用一个不存在的变量时发生的错误。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>另一种触发场景是，将一个值分配给无法分配的对象，比如对函数的运行结果赋值。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面代码对函数<code v-pre>console.log</code>的运行结果赋值，结果引发了<code v-pre>ReferenceError</code>错误。</p>
<h3 id="_15-2-3-rangeerror-对象" tabindex="-1"><a class="header-anchor" href="#_15-2-3-rangeerror-对象" aria-hidden="true">#</a> 15.2.3 RangeError 对象</h3>
<p><code v-pre>RangeError</code>对象是一个值超出有效范围时发生的错误。主要有几种情况，一是数组长度为负数，二是<code v-pre>Number</code>对象的方法参数超出范围，以及函数堆栈超过最大值。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_15-2-4-typeerror-对象" tabindex="-1"><a class="header-anchor" href="#_15-2-4-typeerror-对象" aria-hidden="true">#</a> 15.2.4 TypeError 对象</h3>
<p><code v-pre>TypeError</code>对象是变量或参数不是预期类型时发生的错误。比如，对字符串、布尔值、数值等原始类型的值使用<code v-pre>new</code>命令，就会抛出这种错误，因为<code v-pre>new</code>命令的参数应该是一个构造函数。</p>
...
<h3 id="_15-2-5-urierror-对象" tabindex="-1"><a class="header-anchor" href="#_15-2-5-urierror-对象" aria-hidden="true">#</a> 15.2.5 URIError 对象</h3>
<p><code v-pre>URIError</code>对象是 URI 相关函数的参数不正确时抛出的错误，主要涉及<code v-pre>encodeURI()</code>、<code v-pre>decodeURI()</code>、<code v-pre>encodeURIComponent()</code>、<code v-pre>decodeURIComponent()</code>、<code v-pre>escape()</code>和<code v-pre>unescape()</code>这六个函数。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_15-2-6-evalerror-对象" tabindex="-1"><a class="header-anchor" href="#_15-2-6-evalerror-对象" aria-hidden="true">#</a> 15.2.6 EvalError 对象</h3>
<p><code v-pre>eval</code>函数没有被正确执行时，会抛出<code v-pre>EvalError</code>错误。该错误类型已经不再使用了，只是为了保证与以前代码兼容，才继续保留。</p>
<h3 id="_15-2-7-总结" tabindex="-1"><a class="header-anchor" href="#_15-2-7-总结" aria-hidden="true">#</a> 15.2.7 总结</h3>
<p>以上这6种派生错误，连同原始的<code v-pre>Error</code>对象，都是构造函数。开发者可以使用它们，手动生成错误对象的实例。这些构造函数都接受一个参数，代表错误提示信息（message）。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_15-3-自定义错误" tabindex="-1"><a class="header-anchor" href="#_15-3-自定义错误" aria-hidden="true">#</a> 15.3 自定义错误</h2>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">new</span> <span class="token class-name">UserError</span><span class="token punctuation">(</span><span class="token string">'这是自定义的错误！'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_15-4-throw-语句" tabindex="-1"><a class="header-anchor" href="#_15-4-throw-语句" aria-hidden="true">#</a> 15.4 throw 语句</h2>
<p><code v-pre>throw</code>语句的作用是手动中断程序执行，抛出一个错误。</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> x <span class="token operator">=</span> <span class="token operator">-</span><span class="token number">1</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>对于 JavaScript 引擎来说，遇到<code v-pre>throw</code>语句，程序就中止了。引擎会接收到<code v-pre>throw</code>抛出的信息，可能是一个错误实例，也可能是其他类型的值。</p>
...
<h2 id="_15-5-try-catch-结构" tabindex="-1"><a class="header-anchor" href="#_15-5-try-catch-结构" aria-hidden="true">#</a> 15.5 try...catch 结构</h2>
<p>一旦发生错误，程序就中止执行了。JavaScript 提供了<code v-pre>try...catch</code>结构，允许对错误进行处理，选择是否往下执行。</p>
...
<p><code v-pre>catch</code>代码块捕获错误之后，程序不会中断，会按照正常流程继续执行下去。</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">try</span> <span class="token punctuation">{</span>
...
<p>为了捕捉不同类型的错误，<code v-pre>catch</code>代码块之中可以加入判断语句。</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">try</span> <span class="token punctuation">{</span>
...
<h2 id="_15-6-finally-代码块" tabindex="-1"><a class="header-anchor" href="#_15-6-finally-代码块" aria-hidden="true">#</a> 15.6 finally 代码块</h2>
<p><code v-pre>try...catch</code>结构允许在最后添加一个<code v-pre>finally</code>代码块，表示不管是否出现错误，都必需在最后运行的语句。</p>
...
<p>下面是<code v-pre>finally</code>代码块用法的典型场景。</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token function">openFile</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<p>下面的例子充分反映了<code v-pre>try...catch...finally</code>这三者之间的执行顺序。</p>
...
<li>如果catch里面不写中断的语句，那么try里面有问题也不会中断运行</li>
</ol>
</div></template>
