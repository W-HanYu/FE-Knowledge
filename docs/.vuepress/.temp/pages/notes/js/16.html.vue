<template><div><h1 id="_19-dom概述" tabindex="-1"><a class="header-anchor" href="#_19-dom概述" aria-hidden="true">#</a> 19.DOM概述</h1>
<h2 id="_19-1-dom基本概念" tabindex="-1"><a class="header-anchor" href="#_19-1-dom基本概念" aria-hidden="true">#</a> 19.1 DOM基本概念</h2>
<p>DOM（Document Object Model，文档对象模型）是 JavaScript 操作 HTML 文档的接口，使文档操作变得非常优雅、简便。</p>
<p>DOM 最大的特点就是将 HTML 文档表示为 “节点树”。</p>
<h2 id="_19-2-dom节点树" tabindex="-1"><a class="header-anchor" href="#_19-2-dom节点树" aria-hidden="true">#</a> 19.2 DOM节点树</h2>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>body</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>h1</span><span class="token punctuation">></span></span>IMOOC<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>h1</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span><span class="token punctuation">></span></span>
        <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>h2</span><span class="token punctuation">></span></span>Coder Dream<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>h2</span><span class="token punctuation">></span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>html</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://i0.hdslb.com/bfs/album/3c25986d57d7f71ae9e2ea36e4008d985264e905.png" alt="image-20220823224712360"></p>
<h2 id="_19-3-节点类型" tabindex="-1"><a class="header-anchor" href="#_19-3-节点类型" aria-hidden="true">#</a> 19.3 节点类型</h2>
...
<li><code v-pre>Attr</code>：网页元素的属性（比如<code v-pre>class=&quot;right&quot;</code>）</li>
...
<p><code v-pre>document.nodeType;	  // 9</code></p>
<table>
<thead>
<tr>
<th>nodeType值</th>
...
<tr>
<td>1</td>
<td>元素节点，例如 <code v-pre>&lt;p&gt;</code> 和 <code v-pre>&lt;div&gt;</code></td>
</tr>
<tr>
<td>3</td>
<td>文字节点</td>
