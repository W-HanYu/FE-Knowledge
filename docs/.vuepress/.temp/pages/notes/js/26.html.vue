<template><div><h1 id="触摸事件和其他常见事件" tabindex="-1"><a class="header-anchor" href="#触摸事件和其他常见事件" aria-hidden="true">#</a> 触摸事件和其他常见事件</h1>
<h1 id="_1-触摸操作概述" tabindex="-1"><a class="header-anchor" href="#_1-触摸操作概述" aria-hidden="true">#</a> 1.触摸操作概述</h1>
...
<p><code v-pre>Touch</code>接口的实例对象用来表示触摸点（一根手指或者一根触摸笔），包括位置、大小、形状、压力、目标元素等属性。有时，触摸动作由多个触摸点（多根手指）组成，多个触摸点的集合由<code v-pre>TouchList</code>接口的实例对象表示。<code v-pre>TouchEvent</code>接口的实例对象代表由触摸引发的事件，只有触摸屏才会引发这一类事件。</p>
<p>很多时候，触摸事件和鼠标事件同时触发，即使这个时候并没有用到鼠标。这是为了让那些只定义鼠标事件、没有定义触摸事件的代码，在触摸屏的情况下仍然能用。如果想避免这种情况，可以用<code v-pre>event.preventDefault</code>方法阻止发出鼠标事件。</p>
<h1 id="_2-touch-接口" tabindex="-1"><a class="header-anchor" href="#_2-touch-接口" aria-hidden="true">#</a> 2.Touch 接口</h1>
<h2 id="_2-1-touch-接口概述" tabindex="-1"><a class="header-anchor" href="#_2-1-touch-接口概述" aria-hidden="true">#</a> 2.1 Touch 接口概述</h2>
<p>Touch 接口代表单个触摸点。触摸点可能是一根手指，也可能是一根触摸笔。</p>
<p>其中一些<code v-pre>event</code>事件属性</p>
<ul>
...
<h2 id="_2-2-touch-接口的实例属性" tabindex="-1"><a class="header-anchor" href="#_2-2-touch-接口的实例属性" aria-hidden="true">#</a> 2.2 Touch 接口的实例属性</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>（2）Touch.screenX，Touch.screenY，Touch.clientX，Touch.clientY，pageX，pageY</strong></p>
...
<p><code v-pre>Touch.radiusX</code>属性和<code v-pre>Touch.radiusY</code>属性，分别返回触摸点周围受到影响的椭圆范围的 X 轴半径和 Y 轴半径，单位为像素。乘以 2 就可以得到触摸范围的宽度和高度。</p>
...
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>（4）Touch.force</strong></p>
...
<h1 id="_3-触摸事件的种类" tabindex="-1"><a class="header-anchor" href="#_3-触摸事件的种类" aria-hidden="true">#</a> 3.触摸事件的种类</h1>
<p>触摸引发的事件，有以下几种。可以通过<code v-pre>TouchEvent.type</code>属性，查看到底发生的是哪一种事件。</p>
<ul>
<li><code v-pre>touchstart</code>：用户开始触摸时触发，它的<code v-pre>target</code>属性返回发生触摸的元素节点。</li>
<li><code v-pre>touchend</code>：用户不再接触触摸屏时（或者移出屏幕边缘时）触发，它的<code v-pre>target</code>属性与<code v-pre>touchstart</code>事件一致的，就是开始触摸时所在的元素节点。它的<code v-pre>changedTouches</code>属性返回一个<code v-pre>TouchList</code>实例，包含所有不再触摸的触摸点（即<code v-pre>Touch</code>实例对象）。</li>
<li><code v-pre>touchmove</code>：用户移动触摸点时触发，它的<code v-pre>target</code>属性与<code v-pre>touchstart</code>事件一致。如果触摸的半径、角度、力度发生变化，也会触发该事件。</li>
<li><code v-pre>touchcancel</code>：触摸点取消时触发，比如在触摸区域跳出一个模态窗口（modal window）、触摸点离开了文档区域（进入浏览器菜单栏）、用户的触摸点太多，超过了支持的上限（自动取消早先的触摸点）。</li>
</ul>
<p>下面是一个例子。</p>
...
<span class="token keyword">function</span> <span class="token function">handleMove</span><span class="token punctuation">(</span><span class="token parameter">evt</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="_4-其他常见事件" tabindex="-1"><a class="header-anchor" href="#_4-其他常见事件" aria-hidden="true">#</a> 4.其他常见事件</h1>
<h2 id="_4-1-资源事件" tabindex="-1"><a class="header-anchor" href="#_4-1-资源事件" aria-hidden="true">#</a> 4.1 资源事件</h2>
<h3 id="_4-1-1-beforeunload-事件" tabindex="-1"><a class="header-anchor" href="#_4-1-1-beforeunload-事件" aria-hidden="true">#</a> 4.1.1 beforeunload 事件</h3>
<p><code v-pre>beforeunload</code>事件在窗口、文档、各种资源将要卸载前触发。它可以用来防止用户不小心卸载资源。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面代码中，用户如果关闭窗口，浏览器会弹出一个窗口，要求用户确认。</p>
<p>浏览器对这个事件的行为很不一致，有的浏览器调用<code v-pre>event.preventDefault()</code>，也会弹出对话框。IE 浏览器需要显式返回一个非空的字符串，才会弹出对话框。而且，大多数浏览器在对话框中不显示指定文本，只显示默认文本。因此，可以采用下面的写法，取得最大的兼容性。</p>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>注意，许多手机浏览器（比如 Safari）默认忽略这个事件，桌面浏览器也有办法忽略这个事件。所以，它可能根本不会生效，不能依赖它来阻止用户关闭浏览器窗口，最好不要使用这个事件。</p>
<p>另外，一旦使用了<code v-pre>beforeunload</code>事件，浏览器就不会缓存当前网页，使用“回退”按钮将重新向服务器请求网页。这是因为监听这个事件的目的，一般是为了网页状态，这时缓存页面的初始状态就没意义了。</p>
<h3 id="_4-1-2-unload-事件" tabindex="-1"><a class="header-anchor" href="#_4-1-2-unload-事件" aria-hidden="true">#</a> 4.1.2 unload 事件</h3>
<p><code v-pre>unload</code>事件在窗口关闭或者<code v-pre>document</code>对象将要卸载时触发。它的触发顺序排在<code v-pre>beforeunload</code>、<code v-pre>pagehide</code>事件后面。</p>
...
<p>该事件可以用<code v-pre>pagehide</code>代替。</p>
<h3 id="_4-1-3-load-事件-error-事件" tabindex="-1"><a class="header-anchor" href="#_4-1-3-load-事件-error-事件" aria-hidden="true">#</a> 4.1.3 load 事件，error 事件</h3>
<p><code v-pre>load</code>事件在页面或某个资源加载成功时触发。注意，页面或资源从浏览器缓存加载，并不会触发<code v-pre>load</code>事件。</p>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>error</code>事件是在页面或资源加载失败时触发。<code v-pre>abort</code>事件在用户取消加载时触发。</p>
...
<p>最后，页面的<code v-pre>load</code>事件也可以用<code v-pre>pageshow</code>事件代替。</p>
<h2 id="_4-2-网页状态事件" tabindex="-1"><a class="header-anchor" href="#_4-2-网页状态事件" aria-hidden="true">#</a> 4.2 网页状态事件</h2>
<h3 id="_4-2-1-domcontentloaded-事件" tabindex="-1"><a class="header-anchor" href="#_4-2-1-domcontentloaded-事件" aria-hidden="true">#</a> 4.2.1 DOMContentLoaded 事件</h3>
<p>网页下载并解析完成以后，浏览器就会在<code v-pre>document</code>对象上触发 DOMContentLoaded 事件。这时，仅仅完成了网页的解析（整张页面的 DOM 生成了），所有外部资源（样式表、脚本、iframe 等等）可能还没有下载结束。也就是说，这个事件比<code v-pre>load</code>事件，发生时间早得多。</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-2-2-readystatechange-事件" tabindex="-1"><a class="header-anchor" href="#_4-2-2-readystatechange-事件" aria-hidden="true">#</a> 4.2.2 readystatechange 事件</h3>
<p><code v-pre>readystatechange</code>事件当 Document 对象和 XMLHttpRequest 对象的<code v-pre>readyState</code>属性发生变化时触发。<code v-pre>document.readyState</code>有三个可能的值：<code v-pre>loading</code>（网页正在加载）、<code v-pre>interactive</code>（网页已经解析完成，但是外部资源仍然处在加载状态）和<code v-pre>complete</code>（网页和所有外部资源已经结束加载，<code v-pre>load</code>事件即将触发）。</p>
...
<h2 id="_4-3-窗口事件" tabindex="-1"><a class="header-anchor" href="#_4-3-窗口事件" aria-hidden="true">#</a> 4.3 窗口事件</h2>
<h3 id="_4-3-1-scroll-事件" tabindex="-1"><a class="header-anchor" href="#_4-3-1-scroll-事件" aria-hidden="true">#</a> 4.3.1 scroll 事件</h3>
<blockquote>
<p>前面的鼠标事件已经介绍过</p>
</blockquote>
<p><code v-pre>scroll</code>事件在文档或文档元素滚动时触发，主要出现在用户拖动滚动条。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>该事件会连续地大量触发，所以它的监听函数之中不应该有非常耗费计算的操作。</p>
<h3 id="_4-3-2-resize-事件" tabindex="-1"><a class="header-anchor" href="#_4-3-2-resize-事件" aria-hidden="true">#</a> 4.3.2 resize 事件</h3>
<p><code v-pre>resize</code>事件在改变浏览器窗口大小时触发，主要发生在<code v-pre>window</code>对象上面。</p>
...
<h3 id="_4-3-3-fullscreenchange-事件-fullscreenerror-事件" tabindex="-1"><a class="header-anchor" href="#_4-3-3-fullscreenchange-事件-fullscreenerror-事件" aria-hidden="true">#</a> 4.3.3 fullscreenchange 事件，fullscreenerror 事件</h3>
<p><code v-pre>fullscreenchange</code>事件在进入或退出全屏状态时触发，该事件发生在<code v-pre>document</code>对象上面。</p>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>fullscreenerror</code>事件在浏览器无法切换到全屏状态时触发。</p>
<h2 id="_4-4-剪贴板事件" tabindex="-1"><a class="header-anchor" href="#_4-4-剪贴板事件" aria-hidden="true">#</a> 4.4 剪贴板事件</h2>
<p>以下三个事件属于剪贴板操作的相关事件。</p>
<ul>
<li><code v-pre>cut</code>：将选中的内容从文档中移除，加入剪贴板时触发。</li>
<li><code v-pre>copy</code>：进行复制动作时触发。</li>
<li><code v-pre>paste</code>：剪贴板内容粘贴到文档后触发。</li>
</ul>
<p>举例来说，如果希望禁止输入框的粘贴事件，可以使用下面的代码。</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>inputElement<span class="token punctuation">.</span><span class="token function">addEventListener</span><span class="token punctuation">(</span><span class="token string">'paste'</span><span class="token punctuation">,</span> <span class="token parameter">e</span> <span class="token operator">=></span> e<span class="token punctuation">.</span><span class="token function">preventDefault</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>上面的代码使得用户无法在<code v-pre>&lt;input&gt;</code>输入框里面粘贴内容。</p>
<p><code v-pre>cut</code>、<code v-pre>copy</code>、<code v-pre>paste</code>这三个事件的事件对象都是<code v-pre>ClipboardEvent</code>接口的实例。<code v-pre>ClipboardEvent</code>有一个实例属性<code v-pre>clipboardData</code>，是一个 DataTransfer 对象，存放剪贴的数据。</p>
...
<h2 id="_4-5-焦点事件" tabindex="-1"><a class="header-anchor" href="#_4-5-焦点事件" aria-hidden="true">#</a> 4.5 焦点事件</h2>
<p>焦点事件发生在元素节点和<code v-pre>document</code>对象上面，与获得或失去焦点相关。它主要包括以下四个事件。</p>
<ul>
<li><code v-pre>focus</code>：元素节点获得焦点后触发，该事件不会冒泡。</li>
<li><code v-pre>blur</code>：元素节点失去焦点后触发，该事件不会冒泡。</li>
<li><code v-pre>focusin</code>：元素节点将要获得焦点时触发，发生在<code v-pre>focus</code>事件之前。该事件会冒泡。</li>
<li><code v-pre>focusout</code>：元素节点将要失去焦点时触发，发生在<code v-pre>blur</code>事件之前。该事件会冒泡。</li>
</ul>
<p>这四个事件的事件对象都继承了<code v-pre>FocusEvent</code>接口。<code v-pre>FocusEvent</code>实例具有以下属性。</p>
<ul>
