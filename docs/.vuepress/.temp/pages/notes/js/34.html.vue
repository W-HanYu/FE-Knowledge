<template><div><h1 id="表单和formdata-对象" tabindex="-1"><a class="header-anchor" href="#表单和formdata-对象" aria-hidden="true">#</a> 表单和FormData 对象</h1>
<h1 id="_1-formdata-对象" tabindex="-1"><a class="header-anchor" href="#_1-formdata-对象" aria-hidden="true">#</a> 1.FormData 对象</h1>
...
<p><code v-pre>FormData()</code>首先是一个构造函数，用来生成表单的实例。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><code v-pre>FormData()</code>构造函数的参数是一个 DOM 的表单元素，构造函数会自动处理表单的键值对。这个参数是可选的，如果省略该参数，就表示一个空的表单。</p>
<p>下面是一个表单。</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token operator">&lt;</span>form id<span class="token operator">=</span><span class="token string">"myForm"</span> name<span class="token operator">=</span><span class="token string">"myForm"</span><span class="token operator">></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>我们用<code v-pre>FormData()</code>处理上面这个表单。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_1-2-实例方法" tabindex="-1"><a class="header-anchor" href="#_1-2-实例方法" aria-hidden="true">#</a> 1.2 实例方法</h2>
...
<span class="token comment">// key1: value1</span>
<span class="token comment">// key2: value2</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="_2-表单的内置验证" tabindex="-1"><a class="header-anchor" href="#_2-表单的内置验证" aria-hidden="true">#</a> 2.表单的内置验证</h1>
<h2 id="_2-1-自动校验" tabindex="-1"><a class="header-anchor" href="#_2-1-自动校验" aria-hidden="true">#</a> 2.1 自动校验</h2>
<p>表单提交的时候，浏览器允许开发者指定一些条件，它会自动验证各个表单控件的值是否符合条件。</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token operator">&lt;</span><span class="token operator">!</span><span class="token operator">--</span> 必填 <span class="token operator">--</span><span class="token operator">></span>
<span class="token operator">&lt;</span>input required<span class="token operator">></span>

<span class="token operator">&lt;</span><span class="token operator">!</span><span class="token operator">--</span> 必须符合正则表达式 <span class="token operator">--</span><span class="token operator">></span>
<span class="token operator">&lt;</span>input pattern<span class="token operator">=</span><span class="token string">"banana|cherry"</span><span class="token operator">></span>

<span class="token operator">&lt;</span><span class="token operator">!</span><span class="token operator">--</span> 字符串长度必须为<span class="token number">6</span>个字符 <span class="token operator">--</span><span class="token operator">></span>
<span class="token operator">&lt;</span>input minlength<span class="token operator">=</span><span class="token string">"6"</span> maxlength<span class="token operator">=</span><span class="token string">"6"</span><span class="token operator">></span>

<span class="token operator">&lt;</span><span class="token operator">!</span><span class="token operator">--</span> 数值必须在<span class="token number">1</span>到<span class="token number">10</span>之间 <span class="token operator">--</span><span class="token operator">></span>
<span class="token operator">&lt;</span>input type<span class="token operator">=</span><span class="token string">"number"</span> min<span class="token operator">=</span><span class="token string">"1"</span> max<span class="token operator">=</span><span class="token string">"10"</span><span class="token operator">></span>

<span class="token operator">&lt;</span><span class="token operator">!</span><span class="token operator">--</span> 必须填入 Email 地址 <span class="token operator">--</span><span class="token operator">></span>
...
<span class="token operator">&lt;</span><span class="token operator">!</span><span class="token operator">--</span> 必须填入 <span class="token constant">URL</span> <span class="token operator">--</span><span class="token operator">></span>
<span class="token operator">&lt;</span>input type<span class="token operator">=</span><span class="token string">"URL"</span><span class="token operator">></span>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token literal-property property">input</span><span class="token operator">:</span>invalid <span class="token punctuation">{</span>
  border<span class="token operator">-</span>color<span class="token operator">:</span> red<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
input<span class="token punctuation">,</span>
<span class="token literal-property property">input</span><span class="token operator">:</span>valid <span class="token punctuation">{</span>
  border<span class="token operator">-</span>color<span class="token operator">:</span> #ccc<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-2-checkvalidity" tabindex="-1"><a class="header-anchor" href="#_2-2-checkvalidity" aria-hidden="true">#</a> 2.2 checkValidity()</h2>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">submitForm</span><span class="token punctuation">(</span><span class="token parameter">action</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-3-setcustomvalidity" tabindex="-1"><a class="header-anchor" href="#_2-3-setcustomvalidity" aria-hidden="true">#</a> 2.3 setCustomValidity()</h2>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token operator">&lt;</span>form action<span class="token operator">=</span><span class="token string">"somefile.php"</span><span class="token operator">></span>
  <span class="token operator">&lt;</span>input
    ...
    pattern<span class="token operator">=</span><span class="token string">"[a-z]{1,15}"</span>
...
<h2 id="_2-4-表单的-novalidate-属性" tabindex="-1"><a class="header-anchor" href="#_2-4-表单的-novalidate-属性" aria-hidden="true">#</a> 2.4 表单的 novalidate 属性</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>如果表单元素没有设置<code v-pre>novalidate</code>属性，那么提交按钮（<code v-pre>&lt;button&gt;</code>或<code v-pre>&lt;input&gt;</code>元素）的<code v-pre>formnovalidate</code>属性也有同样的作用。</p>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>form</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="_3-enctype-属性" tabindex="-1"><a class="header-anchor" href="#_3-enctype-属性" aria-hidden="true">#</a> 3.enctype 属性</h1>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>The first line<span class="token punctuation">.</span>
The second line<span class="token punctuation">.</span>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token operator">?</span>foo<span class="token operator">=</span>bar<span class="token operator">&amp;</span>baz<span class="token operator">=</span>The<span class="token operator">%</span>20first<span class="token operator">%</span>20line<span class="token punctuation">.</span><span class="token operator">%</span>0AThe<span class="token operator">%</span>20second<span class="token operator">%</span>20line<span class="token punctuation">.</span>
...
<div class="language-tex line-numbers-mode" data-ext="tex"><pre v-pre class="language-tex"><code>Content-Type: application/x-www-form-urlencoded

foo=bar<span class="token punctuation">&amp;</span>baz=The+first+line.<span class="token comment">%0D%0AThe+second+line.%0D%0A</span>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token operator">&lt;</span>form
  action<span class="token operator">=</span><span class="token string">"register.php"</span>
  method<span class="token operator">=</span><span class="token string">"post"</span>
  enctype<span class="token operator">=</span><span class="token string">"text/plain"</span>
  onsubmit<span class="token operator">=</span><span class="token string">"AJAXSubmit(this); return false;"</span>
<span class="token operator">></span>
<span class="token operator">&lt;</span><span class="token operator">/</span>form<span class="token operator">></span>
...
<div class="language-tex line-numbers-mode" data-ext="tex"><pre v-pre class="language-tex"><code>Content-Type: text/plain
...
<div class="language-tex line-numbers-mode" data-ext="tex"><pre v-pre class="language-tex"><code>Content-Type: multipart/form-data; boundary=---------------------------314911788813839
...
<h1 id="_4-文件上传" tabindex="-1"><a class="header-anchor" href="#_4-文件上传" aria-hidden="true">#</a> 4.文件上传</h1>
