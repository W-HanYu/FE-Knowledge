<template><div><h1 id="_07-【实操篇-文件权限和搜索查找类命令】" tabindex="-1"><a class="header-anchor" href="#_07-【实操篇-文件权限和搜索查找类命令】" aria-hidden="true">#</a> 07 【实操篇-文件权限和搜索查找类命令】</h1>
<h2 id="_1-文件权限类" tabindex="-1"><a class="header-anchor" href="#_1-文件权限类" aria-hidden="true">#</a> 1.文件权限类</h2>
<h3 id="_1-1-权限管理的重要性" tabindex="-1"><a class="header-anchor" href="#_1-1-权限管理的重要性" aria-hidden="true">#</a> 1.1 权限管理的重要性</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-2-权限位" tabindex="-1"><a class="header-anchor" href="#_1-2-权限位" aria-hidden="true">#</a> 1.2 权限位</h3>
...
<p><img src="https://i0.hdslb.com/bfs/album/96869fad16ee7c68cfda85376370a6260a5ff219.png" alt="image-20220819131621876"></p>
...
<h3 id="_1-3-读写执行权限-r、-w、-x-的含义" tabindex="-1"><a class="header-anchor" href="#_1-3-读写执行权限-r、-w、-x-的含义" aria-hidden="true">#</a> 1.3 读写执行权限（-r、-w、-x）的含义</h3>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@hadoop101 ~<span class="token punctuation">]</span><span class="token comment"># ll</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://i0.hdslb.com/bfs/album/08071bb7f281eb00cbb25e476322ae1ebaf83277.png" alt="image-20220819132433035"></p>
<p>（1）如果查看到是文件：链接数指的是硬链接个数。</p>
<p>（2）如果查看的是文件夹：链接数指的是子文件夹个数。</p>
<h3 id="_1-4-chmod-改变权限" tabindex="-1"><a class="header-anchor" href="#_1-4-chmod-改变权限" aria-hidden="true">#</a> 1.4 chmod 改变权限</h3>
...
<h4 id="_1-4-1-chmod命令使用数字修改文件权限" tabindex="-1"><a class="header-anchor" href="#_1-4-1-chmod命令使用数字修改文件权限" aria-hidden="true">#</a> 1.4.1 chmod命令使用数字修改文件权限</h4>
<p>Linux 系统中，文件的基本权限由 9 个字符组成，以 <code v-pre>rwxrw-r-x</code> 为例，我们可以使用数字来代表各个权限，各个权限与数字的对应关系如下：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>r --<span class="token operator">></span> <span class="token number">4</span>
w --<span class="token operator">></span> <span class="token number">2</span>
x --<span class="token operator">></span> <span class="token number">1</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>由于这 9 个字符分属 3 类用户，因此每种用户身份包含 3 个权限（r、w、x），通过将 3 个权限对应的数字累加，最终得到的值即可作为每种用户所具有的权限。</p>
<p>拿 rwxrw-r-x 来说，所有者、所属组和其他人分别对应的权限值为：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>所有者 <span class="token operator">=</span> rwx <span class="token operator">=</span> <span class="token number">4</span>+2+1 <span class="token operator">=</span> <span class="token number">7</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>所以，此权限对应的权限值就是 765。</p>
<p>使用数字修改文件权限的 chmod 命令基本格式为：</p>
<p><code v-pre>[root@localhost ~]# chmod [-R] 权限值 文件名</code></p>
<ul>
<li>-R（注意是大写）选项表示连同子目录中的所有文件，也都修改设定的权限。</li>
</ul>
<p>例如，使用如下命令，即可完成对 .bashrc 目录文件的权限修改：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># ls -al .bashrc</span>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># chmod -R 777 .bashrc</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="_1-4-2-chmod命令使用字母修改文件权限" tabindex="-1"><a class="header-anchor" href="#_1-4-2-chmod命令使用字母修改文件权限" aria-hidden="true">#</a> 1.4.2 chmod命令使用字母修改文件权限</h4>
...
<p><img src="https://i0.hdslb.com/bfs/album/d23d9415f6b458accf29eba74ba0c53de5fe8cce.png" alt="image-20220819133048560"></p>
<p>例如，如果我们要设定 .bashrc 文件的权限为 rwxr-xr-x，则可执行如下命令：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># chmod u=rwx,go=rx .bashrc</span>
<span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># ls -al .bashrc</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>再举个例子，如果想要增加 .bashrc 文件的每种用户都可做写操作的权限，可以使用如下命令：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># ls -al .bashrc</span>
-rwxr-xr-x. <span class="token number">1</span> root root <span class="token number">176</span> Sep <span class="token number">22</span> <span class="token number">2004</span> .bashrc
...
<h3 id="_1-5-chown-改变所有者和所属组" tabindex="-1"><a class="header-anchor" href="#_1-5-chown-改变所有者和所属组" aria-hidden="true">#</a> 1.5 chown 改变所有者和所属组</h3>
<p>chown 命令，可以认为是 &quot;change owner&quot; 的缩写，主要用于修改文件（或目录）的所有者，除此之外，这个命令也可以修改文件（或目录）的所属组。</p>
<p>当只需要修改所有者时，可使用如下 chown 命令的基本格式：</p>
<p><code v-pre>[root@localhost ~]# chown [-R] 所有者 文件或目录</code></p>
<ul>
<li>-R（注意大写）选项表示连同子目录中的所有文件，都更改所有者。</li>
</ul>
<p>如果需要同时更改所有者和所属组，chown 命令的基本格式为：</p>
<p><code v-pre>[root@localhost ~]# chown [-R] 所有者:所属组 文件或目录</code></p>
<p>注意，在 chown 命令中，所有者和所属组中间也可以使用点（.），但会产生一个问题，如果用户在设定账号时加入了小数点（例如 zhangsan.temp），就会造成系统误判。因此，建议大家使用冒号连接所有者和所属组。</p>
<p>当然，chown 命令也支持单纯的修改文件或目录的所属组，例如 <code v-pre>chown :group install.log</code> 就表示修改 install.log 文件的所属组，但修改所属组通常使用 chgrp 命令，因此并不推荐大家使用 chown 命令。</p>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># touch file</span>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># cd /home/user</span>
...
<p>【例 3】</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># chown user:group file</span>
<span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># ll file</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-6-chgrp-改变所属组" tabindex="-1"><a class="header-anchor" href="#_1-6-chgrp-改变所属组" aria-hidden="true">#</a> 1.6 chgrp 改变所属组</h3>
<p>hgrp 命令用于修改文件（或目录）的所属组。</p>
<p>为了方便初学者记忆，可以将 chgrp 理解为是 &quot;change group&quot; 的缩写。</p>
<p>chgrp 命令的用法很简单，其基本格式为：</p>
<p><code v-pre>[root@localhost ~]# chgrp [-R] 所属组 文件名（目录名）</code></p>
<ul>
...
<h2 id="_2-搜索查找类" tabindex="-1"><a class="header-anchor" href="#_2-搜索查找类" aria-hidden="true">#</a> 2.搜索查找类</h2>
<h3 id="_2-1-find-查找文件或者目录" tabindex="-1"><a class="header-anchor" href="#_2-1-find-查找文件或者目录" aria-hidden="true">#</a> 2.1 find 查找文件或者目录</h3>
...
<p><code v-pre>[root@hadoop101 ~]# find xiyou/ -name &quot;*.txt&quot; </code></p>
<p>(2) 将当前目录及其子目录下所有文件后缀为 <strong>.c</strong> 的文件列出来</p>
<p><code v-pre>find . -name &quot;*.c&quot;</code></p>
<p>（3）按拥有者：查找/opt目录下，用户名称为-user的文件</p>
<p><code v-pre>[root@hadoop101 ~]# find xiyou/ -user atguigu </code></p>
<p>（4）按文件大小：在/home目录下查找大于200m的文件（+n 大于 -n小于 n等于）</p>
<p><code v-pre>[root@hadoop101 ~]find /home -size +204800</code></p>
<h3 id="_2-2-locate-快速定位文件路径" tabindex="-1"><a class="header-anchor" href="#_2-2-locate-快速定位文件路径" aria-hidden="true">#</a> 2.2 locate 快速定位文件路径</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>3）案例实操</strong></p>
<p>查询文件夹</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@hadoop101 ~<span class="token punctuation">]</span><span class="token comment"># updatedb</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>查找 passwd 文件，输入以下命令：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@hadoop101 ~<span class="token punctuation">]</span><span class="token comment"># locate passwd</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_2-3-grep-过滤查找" tabindex="-1"><a class="header-anchor" href="#_2-3-grep-过滤查找" aria-hidden="true">#</a> 2.3 grep 过滤查找</h3>
...
<p><code v-pre>grep 选项 查找内容 源文件</code></p>
<ul>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>grep test *file 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>查找前缀有“test”的文件包含“test”字符串的文件</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>$ <span class="token function">grep</span> <span class="token builtin class-name">test</span> test* <span class="token comment">#查找前缀有“test”的文件包含“test”字符串的文件  </span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2、系统报警显示了时间，但是日志文件太大无法直接 cat 查看。(查询含有特定文本的文件，并拿到这些文本所在的行)</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">grep</span> <span class="token parameter variable">-n</span> <span class="token string">'2021-10-24 00:01:11'</span> *.log
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_2-4-管道符" tabindex="-1"><a class="header-anchor" href="#_2-4-管道符" aria-hidden="true">#</a> 2.4 “|”管道符</h3>
<blockquote>
<p>管道符主要用于多重命令处理，前面命令的打印结果作为后面命令的输入。简单点说就是，就像工厂的流水线一样，进行完一道工序后，继续传送给下一道工序处理…</p>
</blockquote>
<p><img src="https://i0.hdslb.com/bfs/album/16d256b0723671e30bec77446903a97ff201a3c6.png" alt="image-20220819143831999"></p>
<p><code v-pre># cat /etc/passwd | grep /bin/bash</code></p>
<p>这条命令使用了两个管道，利用第一个管道将cat命令（显示passwd文件的内容）的输出送给grep命令，grep命令找出含有<code v-pre>/bin/bash</code>的所有行；</p>
<p>**例	**</p>
<p>查找某文件在第几行</p>
<p><code v-pre>[root@hadoop101 ~]# ls | grep -n test</code></p>
<h3 id="_2-5-wc-计算字数" tabindex="-1"><a class="header-anchor" href="#_2-5-wc-计算字数" aria-hidden="true">#</a> 2.5 wc 计算字数</h3>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>wc testfile 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>先查看testfile文件的内容，可以看到：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>$ <span class="token function">cat</span> testfile  
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>使用 wc统计，结果如下：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>其中，3 个数字分别表示testfile文件的行数、单词数，以及该文件的字节数。</p>
<p><strong>例2</strong></p>
<p>如果想同时统计多个文件的信息，例如同时统计testfile、testfile_1、testfile_2，可使用如下命令：</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>wc testfile testfile_1 testfile_2   #统计三个文件的信息 
