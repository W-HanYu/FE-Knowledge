<template><div><h1 id="_08-【实操篇-压缩和解压类】" tabindex="-1"><a class="header-anchor" href="#_08-【实操篇-压缩和解压类】" aria-hidden="true">#</a> 08 【实操篇-压缩和解压类】</h1>
<h2 id="_1-打包-归档-和压缩" tabindex="-1"><a class="header-anchor" href="#_1-打包-归档-和压缩" aria-hidden="true">#</a> 1.打包（归档）和压缩</h2>
...
<h2 id="_2-gzip-gunzip-压缩" tabindex="-1"><a class="header-anchor" href="#_2-gzip-gunzip-压缩" aria-hidden="true">#</a> 2.gzip/gunzip 压缩</h2>
<h3 id="_2-1-gzip压缩文件" tabindex="-1"><a class="header-anchor" href="#_2-1-gzip压缩文件" aria-hidden="true">#</a> 2.1 gzip压缩文件</h3>
<p>gzip 是 Linux 系统中经常用来对文件进行压缩和解压缩的命令，通过此命令压缩得到的新文件，其扩展名通常标记为“.gz”。</p>
<blockquote>
<p>再强调一下，gzip 命令只能用来压缩文件，不能压缩目录，即便指定了目录，也只能压缩目录内的所有文件。</p>
</blockquote>
<p>gzip 命令的基本格式如下：</p>
<p><code v-pre>[root@localhost ~]# gzip [选项] 源文件</code></p>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># gzip install.log</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>【例 2】保留源文件压缩。
在使用 gzip 命令压缩文件时，源文件会消失，从而生成压缩文件。能不能在压缩文件的时候，不让源文件消失？</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># gzip -c anaconda-ks.cfg >anaconda-ks.cfg.gz</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>【例 3】 压缩目录。
我们可能会想当然地认为 gzip 命令可以压缩目录。 我们来试试：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># mkdir test</span>
...
<h3 id="_2-2-gunzip解压缩文件" tabindex="-1"><a class="header-anchor" href="#_2-2-gunzip解压缩文件" aria-hidden="true">#</a> 2.2 gunzip解压缩文件</h3>
<p>gunzip 是一个使用广泛的解压缩命令，它用于解压被 gzip 压缩过的文件（扩展名为 .gz）。</p>
<p>对于解压被 gzip 压缩过的文件，还可以使用 gzip 自己，即 gzip -d 压缩包。</p>
<p>gunzip 命令的基本格式为：</p>
<p><code v-pre>[root@localhost ~]# gunzip [选项] 文件</code></p>
<table>
<thead>
<tr>
<th>选项</th>
...
<p>【例 1】直接解压缩文件。</p>
<p><code v-pre>[root@localhost ~]# gunzip install.log.gz</code></p>
<p>当然，&quot;gunzip -r&quot;依然只会解压缩目录下的文件，而不会解打包。要想解压缩&quot;.gz&quot;格式，还可以使用 &quot;gzip -d&quot;命令，例如：</p>
<p><code v-pre>[root@localhost ~]# gzip -d anaconda-ks.cfg.gz</code></p>
<p>【例 2】要解压缩目录下的内容，则需使用 &quot;-r&quot; 选项，例如：</p>
<p><code v-pre>[root@localhost ~]# gunzip -r test/</code></p>
<p>注意，如果我们压缩的是一个纯文本文件，则可以直接使用 zcat 命令在不解压缩的情况下查看这个文本文件中的内容。例如：</p>
<p><code v-pre>[root@localhost ~]# zcat anaconda-ks.cfg.gz</code></p>
<p><strong>总结</strong></p>
<p>（1）只能压缩文件不能压缩目录</p>
<p>（2）不保留原来的文件</p>
<p>（3）同时多个文件会产生多个压缩包</p>
<h2 id="_3-zip-unzip-压缩" tabindex="-1"><a class="header-anchor" href="#_3-zip-unzip-压缩" aria-hidden="true">#</a> 3.zip/unzip 压缩</h2>
<h3 id="_3-1-zip压缩文件或目录" tabindex="-1"><a class="header-anchor" href="#_3-1-zip压缩文件或目录" aria-hidden="true">#</a> 3.1 zip压缩文件或目录</h3>
...
<p><code v-pre>[root@localhost ~]#zip [选项] 压缩包名 源文件或源目录列表</code></p>
...
<p>下面给大家举几个例子。</p>
<p>【例 1】zip 命令的基本使用。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># zip ana.zip anaconda-ks.cfg</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>不仅如此，所有的压缩命令都可以同时压缩多个文件，例如：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># zip test.zip install.log install.log.syslog</span>
...
<span class="token comment">#压缩文件生成</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>【例 2】使用 zip 命令压缩目录，需要使用“-r”选项，例如：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># mkdir dir1</span>
...
<p><code v-pre>[root@localhost ~]# unzip [选项] 压缩包名</code></p>
<table>
<thead>
<tr>
<th>选项</th>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># unzip dir1.zip</span>
Archive: dir1.zip
creating: dirl/
<span class="token comment">#解压缩</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>【例 2】使用 -d 选项手动指定解压缩位置，例如：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># unzip -d /tmp/ ana.zip</span>
Archive: ana.zip
...
<h2 id="_4-tar-打包" tabindex="-1"><a class="header-anchor" href="#_4-tar-打包" aria-hidden="true">#</a> 4.tar 打包</h2>
...
<h3 id="_4-1-tar命令做打包操作" tabindex="-1"><a class="header-anchor" href="#_4-1-tar命令做打包操作" aria-hidden="true">#</a> 4.1 tar命令做打包操作</h3>
<p>当 tar 命令用于打包操作时，该命令的基本格式为：</p>
<p><code v-pre>[root@localhost ~]#tar [选项] 源文件或目录</code></p>
<table>
<thead>
<tr>
<th>选项</th>
...
<p>【例 1】打包文件和目录。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># tar -cvf anaconda-ks.cfg.tar anaconda-ks.cfg</span>
<span class="token comment">#把anacondehks.cfg打包为 anacondehks.cfg.tar文件</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>选项 &quot;-cvf&quot; 一般是习惯用法，记住打包时需要指定打包之后的文件名，而且要用 &quot;.tar&quot; 作为扩展名。打包目录也是如此：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># ll -d test/</span>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@hadoop101 opt<span class="token punctuation">]</span><span class="token comment"># tar -zcvf houma.tar.gz houge.txt bailongma.txt</span>
houge.txt
bailongma.txt
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>【例 3】打包压缩目录。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@hadoop101 ~<span class="token punctuation">]</span><span class="token comment"># tar -zcvf xiyou.tar.gz xiyou/</span>
xiyou/
xiyou/mingjie/
xiyou/dssz/
xiyou/dssz/houge.txt
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-2-tar命令做解打包操作" tabindex="-1"><a class="header-anchor" href="#_4-2-tar命令做解打包操作" aria-hidden="true">#</a> 4.2 tar命令做解打包操作</h3>
<p>当 tar 命令用于对 tar 包做解打包操作时，该命令的基本格式如下：</p>
<p><code v-pre>[root@localhost ~]#tar [选项] 压缩包</code>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># tar -xvf anaconda-ks.cfg. tar</span>
<span class="token comment">#解打包到当前目录下</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>如果使用 &quot;-xvf&quot; 选项，则会把包中的文件解压到当前目录下。如果想要指定解压位置，则需要使用 &quot;-C(大写)&quot; 选项。例如：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># tar -xvf test.tar -C /tmp</span>
<span class="token comment">#把文件包test.tar解打包到/tmp/目录下</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>如果只想查看文件包中有哪些文件，则可以把解打包选项 &quot;-x&quot; 更换为测试选项 &quot;-t&quot;。例如：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># tar -tvf test.tar</span>
