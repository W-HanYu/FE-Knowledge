<template><div><h1 id="_10-【实操篇-进程管理类】" tabindex="-1"><a class="header-anchor" href="#_10-【实操篇-进程管理类】" aria-hidden="true">#</a> 10 【实操篇-进程管理类】</h1>
...
<h2 id="_1-什么是进程和程序" tabindex="-1"><a class="header-anchor" href="#_1-什么是进程和程序" aria-hidden="true">#</a> 1.什么是进程和程序</h2>
...
<h2 id="_2-进程管理的作用" tabindex="-1"><a class="header-anchor" href="#_2-进程管理的作用" aria-hidden="true">#</a> 2.进程管理的作用</h2>
...
<h2 id="_3-ps-查看当前系统进程状态" tabindex="-1"><a class="header-anchor" href="#_3-ps-查看当前系统进程状态" aria-hidden="true">#</a> 3.ps 查看当前系统进程状态</h2>
...
<p>ps 命令的基本格式如下：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># ps aux</span>
...
<span class="token comment">#可以查看子父进程之间的关系</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>选项：</p>
<ul>
...
<p>【例 1】</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>[root@localhost ~]# ps aux
#查看系统中所有的进程
...
…省略部分输出…
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>以上输出信息中各列的具体含义。</p>
<table>
<thead>
<tr>
<th>表头</th>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># ps -ef</span>
...
<span class="token number">1</span> S   <span class="token number">0</span>   <span class="token number">3</span>    <span class="token number">2</span> <span class="token number">0</span> <span class="token parameter variable">-40</span>   - -      <span class="token number">0</span> -     ?    00:00:00  migration/0
...
<span class="token number">1</span> S   <span class="token number">0</span>   <span class="token number">5</span>    <span class="token number">2</span> <span class="token number">0</span> <span class="token parameter variable">-40</span>   - -      <span class="token number">0</span> -     ?    00:00:00  migration/0
…省略部分输出…
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>以上输出信息中各列的含义。</p>
<table>
<thead>
<tr>
<th>表头</th>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># ps -l</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>可以看到，这次从 pts/1 虚拟终端登录，只产生了两个进程：一个是登录之后生成的 Shell，也就是 bash；另一个是正在执行的 ps 命令。</p>
...
<h2 id="_4-kill-终止进程" tabindex="-1"><a class="header-anchor" href="#_4-kill-终止进程" aria-hidden="true">#</a> 4.kill 终止进程</h2>
<h3 id="_4-1-kill-终止进程" tabindex="-1"><a class="header-anchor" href="#_4-1-kill-终止进程" aria-hidden="true">#</a> 4.1 kill 终止进程</h3>
...
<p>kill 命令的基本格式如下：</p>
<p><code v-pre>[root@localhost ~]# kill [信号] PID</code></p>
...
<p>【例 1】 标准 kill 命令。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># kill 2248</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>【例 2】使用“-1”信号，让进程重启。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># kill -1 2246</span>
使用“-1 <span class="token punctuation">(</span>数字1<span class="token punctuation">)</span>”信号，让httpd的主进程重新启动
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>学会如何使用 kill 命令之后，再思考一个问题，使用 kill 命令一定可以终止一个进程吗？</p>
<p>答案是否定的。文章开头说过，kill 命令只是“发送”一个信号，因此，只有当信号被程序成功“捕获”，系统才会执行 kill 命令指定的操作；反之，如果信号被“封锁”或者“忽略”，则 kill 命令将会失效。</p>
<h3 id="_4-2-killall-终止特定的一类进程" tabindex="-1"><a class="header-anchor" href="#_4-2-killall-终止特定的一类进程" aria-hidden="true">#</a> 4.2  killall 终止特定的一类进程</h3>
...
<p><code v-pre>[root@localhost ~]# killall [选项] 进程名</code></p>
...
<p>接下来，给大家举几个例子。</p>
<p>【例 1】杀死 httpd 进程。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># killall httpd</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5-pstree-查看进程树" tabindex="-1"><a class="header-anchor" href="#_5-pstree-查看进程树" aria-hidden="true">#</a> 5.pstree 查看进程树</h2>
<p>pstree 命令是以树形结构显示程序和进程之间的关系，此命令的基本格式如下：</p>
<p><code v-pre>[root@localhost ~]# pstree [选项] [PID或用户名]</code></p>
...
【例 1】</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@1ocalhost ~<span class="token punctuation">]</span><span class="token comment"># pstree</span>
init──┬──abrc-dump-oopa
├──abrtd
├──acpid
...
├──udevd───2<span class="token punctuation">[</span>udevd
└──xinecd
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>【例 2】如果想知道某个用户都启动了哪些进程，使用 pstree 命令可以很容易实现，以 mysql 用户为例：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@1ocalhost ~<span class="token punctuation">]</span><span class="token comment"># pstree mysql</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>此输出结果显示了 mysql 用户对应的进程为 mysqid，并且 mysqid 进程拥有 5 个子进程（外加 1 个父进程，共计 6 个进程）。</p>
<h2 id="_6-top-实时监控系统进程状态" tabindex="-1"><a class="header-anchor" href="#_6-top-实时监控系统进程状态" aria-hidden="true">#</a> 6.top 实时监控系统进程状态</h2>
...
<p>使用权限：所有使用者。</p>
<p>top 命令的基本格式如下：</p>
<p><code v-pre>[root@localhost ~]#top [选项]</code></p>
<p>选项：</p>
<ul>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># top</span>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># top -p 15273</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_7-netstat-显示网络状态和端口占用信息" tabindex="-1"><a class="header-anchor" href="#_7-netstat-显示网络状态和端口占用信息" aria-hidden="true">#</a> 7.netstat 显示网络状态和端口占用信息</h2>
<p><strong>1）基本语法</strong></p>
<p><code v-pre>netstat -anp | grep 进程号 （功能描述：查看该进程网络信息） </code></p>
<p><code v-pre>netstat –nlp | grep 端口号 （功能描述：查看网络端口号占用情况</code></p>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@hadoop101 hadoop-2.7.2<span class="token punctuation">]</span><span class="token comment"># netstat -anp | grep sshd</span>
...
<span class="token number">951</span>/sshd
tcp <span class="token number">0</span> <span class="token number">0</span> <span class="token number">192.168</span>.202.100:22 <span class="token number">192.168</span>.202.1:57741
ESTABLISHED <span class="token number">3380</span>/sshd: root@pts
tcp <span class="token number">0</span> <span class="token number">52</span> <span class="token number">192.168</span>.202.100:22 <span class="token number">192.168</span>.202.1:57783
ESTABLISHED <span class="token number">3568</span>/sshd: root@pts
tcp <span class="token number">0</span> <span class="token number">0</span> <span class="token number">192.168</span>.202.100:22 <span class="token number">192.168</span>.202.1:57679
ESTABLISHED <span class="token number">3142</span>/sshd: root@pts
tcp6 <span class="token number">0</span> <span class="token number">0</span> :::22 :::* LISTEN
<span class="token number">951</span>/sshd
unix <span class="token number">2</span> <span class="token punctuation">[</span> <span class="token punctuation">]</span> DGRAM <span class="token number">39574</span> <span class="token number">3568</span>/sshd:
root@pts
unix <span class="token number">2</span> <span class="token punctuation">[</span> <span class="token punctuation">]</span> DGRAM <span class="token number">37452</span> <span class="token number">3142</span>/sshd:
root@pts
unix <span class="token number">2</span> <span class="token punctuation">[</span> <span class="token punctuation">]</span> DGRAM <span class="token number">48651</span> <span class="token number">3380</span>/sshd:
root@pts
unix <span class="token number">3</span> <span class="token punctuation">[</span> <span class="token punctuation">]</span> STREAM CONNECTED <span class="token number">21224</span> <span class="token number">951</span>/sshd
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>（2）查看某端口号是否被占用</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token punctuation">[</span>root@hadoop101 桌面<span class="token punctuation">]</span><span class="token comment"># netstat -nltp | grep 22</span>
...
<span class="token number">1324</span>/dnsmasq
tcp <span class="token number">0</span> <span class="token number">0</span> <span class="token number">0.0</span>.0.0:22 <span class="token number">0.0</span>.0.0:* LISTEN
<span class="token number">951</span>/sshd
tcp6 <span class="token number">0</span> <span class="token number">0</span> :::22 :::* LISTEN
<span class="token number">951</span>/sshd
