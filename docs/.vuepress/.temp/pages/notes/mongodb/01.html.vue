...
<p>https://github.com/Vacricticy/mongodb_practice</p>
<p><a href="https://blog.csdn.net/lyyrhf/article/details/115469161" target="_blank" rel="noopener noreferrer">MongoDB超详细保姆级入门教程！_你的笑只是保护色的博客-CSDN博客<ExternalLinkIcon/></a></p>
<h2 id="_1-下载安装" tabindex="-1"><a class="header-anchor" href="#_1-下载安装" aria-hidden="true">#</a> 1.下载安装</h2>
<h3 id="_1-1-下载mongodb" tabindex="-1"><a class="header-anchor" href="#_1-1-下载mongodb" aria-hidden="true">#</a> 1.1 下载MongoDB</h3>
...
<p><img src="https://tva1.sinaimg.cn/large/0074UQWJgy1h3egzpj5qdj31dt0nzk40.jpg" alt="image-20220618195425165"></p>
<blockquote>
<p>mongodb 可以不用配置环境变量。配置环境变量只是为了能在终端（cmd窗口）任意路径中执行bin目录中的命令，就是起到一个方便的作用。</p>
<p>环境变量也非常的简单,<code v-pre>H:\mongoDB\bin</code>将这个添加到系统变量path</p>
...
<h3 id="_1-2-创建目录及配置文件" tabindex="-1"><a class="header-anchor" href="#_1-2-创建目录及配置文件" aria-hidden="true">#</a> 1.2 创建目录及配置文件</h3>
<p><img src="https://img-blog.csdnimg.cn/20210406195537258.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2x5eXJoZg==,size_16,color_FFFFFF,t_70" alt="img"></p>
<p>接下来在 F盘创建 <code v-pre>data</code> 目录，继续在 <code v-pre>data</code> <strong>目录下</strong>创建 <code v-pre>db</code> 以及 <code v-pre>log</code>。<strong><code v-pre>log</code> 目录中还需要创建 <code v-pre>mongod.log</code> 文件</strong>。这个文件一定要创建否则找不到会报错。</p>
<ul>
<li>db：表示数据存储的文件夹</li>
<li>log：表示日志打印的文件夹</li>
</ul>
<p><img src="https://i0.hdslb.com/bfs/album/a61b017b4467cdfa5d0956ac0d1f5617dc3a13b2.png" alt="image-20220618194533964"></p>
<p>然后在 <code v-pre>bin</code> 目录的<strong>同级</strong>目录创建 <code v-pre>mongod.cfg</code> 文件（说明：配置创建路径其实可以随意，但是不建议😅。后缀也可以随意，建议语义化点比如：cfg、config、conf…），并写入如下内容，<strong>注意：配置件缩进需要使用tab键</strong>（根据自己安装的路径来配置）。</p>
<p><img src="https://tva1.sinaimg.cn/large/0074UQWJgy1h3eh2u3hn2j30mt0d2795.jpg" alt="image-20220618194730846"></p>
<p><strong>mongod.cfg</strong></p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># mongod.conf</span>
...
<h3 id="_1-3-添加到服务-开机自动启动" tabindex="-1"><a class="header-anchor" href="#_1-3-添加到服务-开机自动启动" aria-hidden="true">#</a> 1.3 添加到服务（开机自动启动）</h3>
<p>只有将 <code v-pre>mongodb</code> 添加到系统服务中，他才能自动启动。</p>
<p><strong>注意</strong>！！<strong>必须以管理员身份打开 <code v-pre>cmd</code> 窗口。</strong></p>
<p><img src="https://tva1.sinaimg.cn/large/0074UQWJgy1h3eh31effmj30xx0hvwfm.jpg" alt="image-20220618194902474"></p>
<p><img src="https://img-blog.csdnimg.cn/8533efb70d064648a8307ff3f0217095.jpg?x-oss-process=image/watermark,type_ZHJvaWRzYW5zZmFsbGJhY2s,shadow_50,text_Q1NETiBA5a-45aS055S355Sf,size_20,color_FFFFFF,t_70,g_se,x_16#pic_center" alt="server"></p>
<p><strong>这里表示执行配置文件，需要写入你的配置文件路径：</strong></p>
<div class="language-tex line-numbers-mode" data-ext="tex"><pre v-pre class="language-tex"><code>mongod --config H:<span class="token function selector">\mongodb</span><span class="token function selector">\bin</span><span class="token function selector">\mongod</span>.cfg --install --serviceName "mongodb"
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>如果配置文件执行报错，最终无法启动，那么就自己在命令行配置mongoDB，把上面需要执行的命令替换为如下命令即可(注意修改自己的路径)</strong></p>
<div class="language-tex line-numbers-mode" data-ext="tex"><pre v-pre class="language-tex"><code>mongod --dbpath "F:<span class="token function selector">\data</span><span class="token function selector">\db</span>" --logpath "F:<span class="token function selector">\data</span><span class="token function selector">\log</span><span class="token function selector">\mongod</span>.log" --install --serviceName "mongodb"
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>启动mongoDB：</strong></p>
<div class="language-tex line-numbers-mode" data-ext="tex"><pre v-pre class="language-tex"><code>net start mongodb
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>后续如果修改 mongoDB 的端口就直接改配置文件，删除服务（服务的删除执行命令：sc delete mongodb），重新执行“添加到服务”</strong></p>
<h3 id="_1-4-检查" tabindex="-1"><a class="header-anchor" href="#_1-4-检查" aria-hidden="true">#</a> 1.4 检查</h3>
<p>在键盘上按 “WIN+R”，输入“services.msc”指令确定。</p>
<p>打开服务后，找到MongoDB，如下图表示已经成功！</p>
<p><img src="https://tva1.sinaimg.cn/large/0074UQWJgy1h3eh3cmeu6j314t0g2qdn.jpg" alt="image-20220618195406910"></p>
<p>到这里你已经完成了 mongoDB 的所有配置。接下来如果你需要连接数据库。分两种情况：</p>
<ul>
<li>使用 cmd 命令窗口连接
<ul>
<li>如果你已经配置了环境变量，直接在 cmd 窗口中输入 <code v-pre>mongo</code> 即可连接成功</li>
<li>如果没有配置环境变量，则需要在 bin 目录中打开 cmd 窗口，输入 <code v-pre>mongo</code></li>
</ul>
</li>
</ul>
<h2 id="_2-基本介绍" tabindex="-1"><a class="header-anchor" href="#_2-基本介绍" aria-hidden="true">#</a> 2.基本介绍</h2>
<p><img src="https://tva1.sinaimg.cn/large/0074UQWJgy1h3eh3jh74yj30id0jajzd.jpg" alt="image.png"></p>
<p><img src="https://tva1.sinaimg.cn/large/0074UQWJgy1h3eh3p846vj30n70c0adr.jpg" alt="image-20220618195909214"></p>
...
<p><img src="https://tva1.sinaimg.cn/large/0074UQWJgy1h3eh3xhtbwj310m0bj75i.jpg" alt="image-20220618195919953"></p>
<h2 id="_3-基本操作" tabindex="-1"><a class="header-anchor" href="#_3-基本操作" aria-hidden="true">#</a> 3.基本操作</h2>
...
<h2 id="_4-插入文档" tabindex="-1"><a class="header-anchor" href="#_4-插入文档" aria-hidden="true">#</a> 4.插入文档</h2>
<ul>
<li>插入一条数据
<ul>
...
该属性用来作为文档的唯一标识
<code v-pre>_id</code>可以自己指定，如果我们指定了，数据库就不会再添加了,如果自己指定_id必须也确保唯一性</p>
</blockquote>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>db<span class="token punctuation">.</span>stus<span class="token punctuation">.</span><span class="token function">insert</span><span class="token punctuation">(</span><span class="token punctuation">{</span><span class="token literal-property property">name</span><span class="token operator">:</span><span class="token string">"Ustinian"</span><span class="token punctuation">,</span><span class="token literal-property property">age</span><span class="token operator">:</span><span class="token number">28</span><span class="token punctuation">,</span><span class="token literal-property property">gender</span><span class="token operator">:</span><span class="token string">"男"</span><span class="token punctuation">}</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5-查询文档" tabindex="-1"><a class="header-anchor" href="#_5-查询文档" aria-hidden="true">#</a> 5.查询文档</h2>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>#查询集合中的所有文档
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>db.stus.find({}).count()</strong></p>
<p>查询所有结果的数量</p>
<blockquote>
<ul>
<li>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code># <span class="token number">1</span><span class="token punctuation">.</span>mongodb支持直接通过内嵌文档的属性值进行查询
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_6-删除文档" tabindex="-1"><a class="header-anchor" href="#_6-删除文档" aria-hidden="true">#</a> 6.删除文档</h2>
<ul>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code># <span class="token number">1.</span> db<span class="token punctuation">.</span>collectionName<span class="token punctuation">.</span><span class="token function">remove</span><span class="token punctuation">(</span><span class="token punctuation">)</span> 
...
<h2 id="_7-修改文档" tabindex="-1"><a class="header-anchor" href="#_7-修改文档" aria-hidden="true">#</a> 7.修改文档</h2>
<ul>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code># <span class="token number">1.</span><span class="token function">替换整个文档</span><span class="token punctuation">(</span>只修改查找到的第一个<span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_8-文档之间的关系" tabindex="-1"><a class="header-anchor" href="#_8-文档之间的关系" aria-hidden="true">#</a> 8.文档之间的关系</h2>
<p><strong>一对一</strong></p>
<p>在MongoDB中，可以通过内嵌文档的形式来体现出一对一的关系</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>db.WifeAndHusband.insert<span class="token punctuation">(</span><span class="token punctuation">[</span>
    <span class="token punctuation">{</span>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>#用户与订单：
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>#老师与学生
...
db<span class="token punctuation">.</span>students<span class="token punctuation">.</span><span class="token function">insert</span><span class="token punctuation">(</span><span class="token punctuation">[</span>
	...
	<span class="token punctuation">}</span>
<span class="token punctuation">]</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_9-命令汇总" tabindex="-1"><a class="header-anchor" href="#_9-命令汇总" aria-hidden="true">#</a> 9.命令汇总</h2>
