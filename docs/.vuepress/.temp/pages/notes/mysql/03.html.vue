<template><div><h1 id="_03-【基本的select语句】" tabindex="-1"><a class="header-anchor" href="#_03-【基本的select语句】" aria-hidden="true">#</a> 03 【基本的SELECT语句】</h1>
<h2 id="_1-sql分类" tabindex="-1"><a class="header-anchor" href="#_1-sql分类" aria-hidden="true">#</a> 1.SQL分类</h2>
...
<ul>
<li>主要的语句关键字包括<code v-pre>CREATE</code>、<code v-pre>DROP</code>、<code v-pre>ALTER</code>、<code v-pre>RENAME</code>、<code v-pre>TRUNCATE</code>等。</li>
</ul>
</li>
...
<p>注：因为查询语句使用的非常的频繁，所以很多人把查询语句单拎出来一类：<strong>DQL（数据查询语言）</strong>。还有单独将<code v-pre>COMMIT</code>、<code v-pre>ROLLBACK</code> 取出来称为<strong>TCL （Transaction Control Language，事务控制语言）</strong>。</p>
...
<li>列的别名，尽量使用双引号 &quot; &quot; ，切记不要使用单引号 ，而且不建议省略as</li>
</ul>
</li>
</ul>
...
<li><code v-pre>推荐采用统一的书写规范：</code>
<ul>
...
<h3 id="_2-3-注释" tabindex="-1"><a class="header-anchor" href="#_2-3-注释" aria-hidden="true">#</a> 2.3 注释</h3>
<p>可以使用如下格式的注释结构</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code>单行注释：<span class="token comment">#注释文字(MySQL特有的方式)</span>
...
<li><strong>必须保证你的字段没有和保留字、数据库系统或常用方法冲突。如果坚持使用，请在SQL语句中使用`（着重号）引起来</strong></li>
<li>保持字段名和类型的一致性，在命名字段并为其指定数据类型的时候一定要保证一致性。假如数据类型在一个表里是整数，那在另一个表里可就别变成字符型了</li>
</ul>
<p>举例：</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token comment">#以下两句是一样的，不区分大小写</span>
...
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code>mysql<span class="token operator">></span> source d:\mysqldb<span class="token punctuation">.</span><span class="token keyword">sql</span>
...
<h3 id="_3-1-select-from" tabindex="-1"><a class="header-anchor" href="#_3-1-select-from" aria-hidden="true">#</a> 3.1 SELECT ... FROM</h3>
<ul>
<li>语法：</li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://i0.hdslb.com/bfs/album/1d2dfd6299a889354e954ad4517fae248fea4caf.png" alt="image-20221010152734991"></p>
<blockquote>
...
<li>
<p>紧跟列名，也可以<strong>在列名和别名之间加入关键字AS，<code v-pre>别名使用双引号(不能使用单引号)</code></strong>，以便在别名中包含空格或特殊的字符并区分大小写。</p>
</li>
<li>
<p>AS 可以省略</p>
</li>
...
<li>
<p>举例</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">SELECT</span> last_name <span class="token keyword">AS</span> name<span class="token punctuation">,</span> commission_pct comm
<span class="token keyword">FROM</span>   employees<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div></li>
</ul>
<p><img src="https://i0.hdslb.com/bfs/album/463c03536c07786a91f1d0b75169408f2e037584.png" alt="image-20221010153104353"></p>
...
<span class="token keyword">FROM</span>   employees<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://i0.hdslb.com/bfs/album/6c019987e827f018ccd7f54ab58b26c287efc5e2.png" alt="image-20221010153149912"></p>
...
<span class="token keyword">FROM</span>   employees<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://i0.hdslb.com/bfs/album/f7b92eef771141bee11ccfd51bdb677f151bbca3.png" alt="image-20221010153218402"></p>
...
<span class="token keyword">FROM</span>   employees<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://i0.hdslb.com/bfs/album/e376c1ab86fe5521739f32de0e649bf8ca68436b.png" alt="image-20221010153249250"></p>
<p>针对于：</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">SELECT</span> <span class="token keyword">DISTINCT</span> department_id<span class="token punctuation">,</span>salary 
<span class="token keyword">FROM</span> employees<span class="token punctuation">;</span>
...
<li>DISTINCT 其实是<code v-pre>对后面所有列名的组合进行去重</code>（也就是说 department_id 和salary被看成一个整体，其他记录的department_id 和salary 必须等于前面出现的才可以去重），你能看到最后的结果是 74 条，因为这 74 个部门id不同，都有 salary 这个属性值。如果你想要看都有哪些不同的部门（department_id），只需要写<code v-pre>DISTINCT department_id</code>即可，后面不需要再加其他的列名了。</li>
</ol>
...
<span class="token keyword">FROM</span> employees<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这里你一定要注意，在 MySQL 里面， 空值null不等于空字符串。一个空字符串的长度是 0，而一个空值的长度是空。而且，在 MySQL 里面，空值是占用空间的。</p>
<p>补充：null 不等于 0，不等于 ' '，也不等于 'null'</p>
<h3 id="_3-5-着重号" tabindex="-1"><a class="header-anchor" href="#_3-5-着重号" aria-hidden="true">#</a> 3.5 着重号</h3>
<ul>
<li>错误的</li>
</ul>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code>mysql<span class="token operator">></span> <span class="token keyword">SELECT</span> <span class="token operator">*</span> <span class="token keyword">FROM</span> <span class="token keyword">ORDER</span><span class="token punctuation">;</span>
...
<h3 id="_3-6-查询常数" tabindex="-1"><a class="header-anchor" href="#_3-6-查询常数" aria-hidden="true">#</a> 3.6 查询常数</h3>
...
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">SELECT</span> <span class="token string">'尚硅谷'</span> <span class="token keyword">as</span> corporation<span class="token punctuation">,</span> last_name <span class="token keyword">FROM</span> employees<span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="https://i0.hdslb.com/bfs/album/24ea100148c6461e7e2c51f072d5031fde60002e.png" alt="image-20221012131734107"></p>
<h2 id="_4-显示表结构" tabindex="-1"><a class="header-anchor" href="#_4-显示表结构" aria-hidden="true">#</a> 4. 显示表结构</h2>
<p>使用DESCRIBE 或 DESC 命令，表示表结构。</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">DESCRIBE</span> employees<span class="token punctuation">;</span>
或
...
<li>Extra：表示可以获取与给定列有关的附加信息，例如AUTO_INCREMENT等。</li>
</ul>
<h2 id="_5-过滤数据" tabindex="-1"><a class="header-anchor" href="#_5-过滤数据" aria-hidden="true">#</a> 5. 过滤数据</h2>
<ul>
<li>背景：</li>
</ul>
<p><img src="https://i0.hdslb.com/bfs/album/e3f7e8352bed8e7d1f2bbd689bf4627d6a078d35.png" alt="image-20221010154834945"></p>
<ul>
<li>
<p>语法：</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">SELECT</span> 字段<span class="token number">1</span><span class="token punctuation">,</span>字段<span class="token number">2</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_6-课后练习" tabindex="-1"><a class="header-anchor" href="#_6-课后练习" aria-hidden="true">#</a> 6.课后练习</h2>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token comment">#第03章_基本的SELECT语句的课后练习</span>

<span class="token comment"># 1.查询员工12个月的工资总和，并起别名为ANNUAL SALARY</span>
<span class="token comment">#理解1：计算12月的基本工资</span>
<span class="token keyword">SELECT</span> employee_id<span class="token punctuation">,</span>last_name<span class="token punctuation">,</span>salary <span class="token operator">*</span> <span class="token number">12</span> <span class="token string">"ANNUAL SALARY"</span>
<span class="token keyword">FROM</span> employees<span class="token punctuation">;</span>

<span class="token comment">#理解2：计算12月的基本工资和奖金</span>
...
<span class="token comment"># 2.查询employees表中去除重复的job_id以后的数据</span>
<span class="token keyword">SELECT</span> <span class="token keyword">DISTINCT</span> job_id
<span class="token keyword">FROM</span> employees<span class="token punctuation">;</span>

<span class="token comment"># 3.查询工资大于12000的员工姓名和工资</span>
...
<span class="token comment"># 4.查询员工号为176的员工的姓名和部门号</span>
<span class="token keyword">SELECT</span> last_name<span class="token punctuation">,</span>department_id
<span class="token keyword">FROM</span> employees
<span class="token keyword">WHERE</span> employee_id <span class="token operator">=</span> <span class="token number">176</span><span class="token punctuation">;</span>

<span class="token comment"># 5.显示表 departments 的结构，并查询其中的全部数据 </span>
