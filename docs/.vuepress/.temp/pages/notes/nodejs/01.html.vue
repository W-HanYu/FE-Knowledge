<template><div><h1 id="_01-【nodejs简介】" tabindex="-1"><a class="header-anchor" href="#_01-【nodejs简介】" aria-hidden="true">#</a> 01 【nodejs简介】</h1>
...
<h3 id="_1-1-前端同学为什么要学习后端-后端同学为什么要学习前端" tabindex="-1"><a class="header-anchor" href="#_1-1-前端同学为什么要学习后端-后端同学为什么要学习前端" aria-hidden="true">#</a> 1.1 前端同学为什么要学习后端/后端同学为什么要学习前端</h3>
<ul>
<li>了解前后端交互流程。</li>
...
<h3 id="_1-2-前端同学为什么要学-node-js" tabindex="-1"><a class="header-anchor" href="#_1-2-前端同学为什么要学-node-js" aria-hidden="true">#</a> 1.2 前端同学为什么要学 Node.js</h3>
...
<h2 id="_2-node-js是什么" tabindex="-1"><a class="header-anchor" href="#_2-node-js是什么" aria-hidden="true">#</a> 2.Node.js是什么？</h2>
<h3 id="_2-1-官方定义" tabindex="-1"><a class="header-anchor" href="#_2-1-官方定义" aria-hidden="true">#</a> 2.1 官方定义</h3>
<p><a href="https://nodejs.org/zh-cn/" target="_blank" rel="noopener noreferrer">Node.js<ExternalLinkIcon/></a> 是一个基于 <strong>Chrome V8 引擎</strong>的 JavaScript 运行环境。Node.js 使用了一个<strong>事件驱动</strong>、<strong>非阻塞式 I/O</strong>的模型，使其轻量又高效。Node.js 的包管理工具 npm 是全球最大的开源库生态系统。</p>
<p>Node.js 不是一门语言，也不是 JavaScript 的框架，也不是像Nginx一样的Web服务器 ，<strong>Node.js 是 JavaScript 在服务器端的运行环境（平台）</strong>。</p>
<h3 id="_2-2-node-js-的组成" tabindex="-1"><a class="header-anchor" href="#_2-2-node-js-的组成" aria-hidden="true">#</a> 2.2 Node.js 的组成</h3>
...
<p>如下图所示：</p>
<p><img src="https://i0.hdslb.com/bfs/album/bab95704bf2f5dd8e05236c74a98d487fafa6d41.png" alt="image-20221102140543274"></p>
<h3 id="_2-3-小总结" tabindex="-1"><a class="header-anchor" href="#_2-3-小总结" aria-hidden="true">#</a> 2.3 小总结</h3>
<ul>
...
<h2 id="_3-node-js-的应用" tabindex="-1"><a class="header-anchor" href="#_3-node-js-的应用" aria-hidden="true">#</a> 3.Node.js 的应用</h2>
...
<h3 id="_3-1-bff-中间层" tabindex="-1"><a class="header-anchor" href="#_3-1-bff-中间层" aria-hidden="true">#</a> 3.1 BFF 中间层</h3>
<p>BFF，即 Backend For Frontend（服务于前端的后端）。玉伯在《<a href="https://mp.weixin.qq.com/s/IYddaaw2ps1wR2VT1dZWPg" target="_blank" rel="noopener noreferrer">从前端技术进化到体验科技<ExternalLinkIcon/></a>》这篇文章中点出了 BFF 层的概念：</p>
<blockquote>
...
<h3 id="_3-2-服务端渲染" tabindex="-1"><a class="header-anchor" href="#_3-2-服务端渲染" aria-hidden="true">#</a> 3.2 服务端渲染</h3>
...
<p>参考链接：</p>
<ul>
<li><a href="https://ssr.vuejs.org/zh/" target="_blank" rel="noopener noreferrer">Vue 服务端渲染的概念<ExternalLinkIcon/></a></li>
<li>https://blog.csdn.net/u012036171/article/details/88833200</li>
<li>https://juejin.im/post/5c068fd8f265da61524d2abc</li>
<li><a href="https://www.zhihu.com/question/59578433/answer/326694511" target="_blank" rel="noopener noreferrer">方应杭<ExternalLinkIcon/></a></li>
</ul>
<p>历史回顾：</p>
...
<h3 id="_3-3-做小型服务、小型网站的后端-基于-express、koa-框架" tabindex="-1"><a class="header-anchor" href="#_3-3-做小型服务、小型网站的后端-基于-express、koa-框架" aria-hidden="true">#</a> 3.3 做小型服务、小型网站的后端（基于 Express、Koa 框架）</h3>
...
<h3 id="_3-4-做项目构建工具" tabindex="-1"><a class="header-anchor" href="#_3-4-做项目构建工具" aria-hidden="true">#</a> 3.4 做项目构建工具</h3>
<p>前端正在广泛使用的构建工具 gulp、Webpack，就是基于 Node.js 来实现的。</p>
<h3 id="_3-5-做-pc-客户端软件-基于-electron-框架" tabindex="-1"><a class="header-anchor" href="#_3-5-做-pc-客户端软件-基于-electron-框架" aria-hidden="true">#</a> 3.5 做 PC 客户端软件（基于 Electron 框架）</h3>
...
<p>还有一个例子是：电子游戏直播网站 <a href="https://www.twitch.tv/" target="_blank" rel="noopener noreferrer">Twitch<ExternalLinkIcon/></a>，号称是国外游戏直播的鼻祖，它在 PC 端的客户端软件，就是用 Electron 框架的。你会发现，Twitch 的网站视觉，和 PC 端的视觉，几乎是一样的。如果两端都采用 JS 语言，就可以极大的复用现有的工程。</p>
<h3 id="_3-6-知名度较高的-node-js-开源项目" tabindex="-1"><a class="header-anchor" href="#_3-6-知名度较高的-node-js-开源项目" aria-hidden="true">#</a> 3.6 知名度较高的 Node.js 开源项目</h3>
<p><img src="https://i0.hdslb.com/bfs/album/ea53e535fbda0627b4bab6bf90592e0d151a5ec2.png" alt="image-20221102140856507"></p>
<ul>
<li>
...
<li>
<p><a href="https://eggjs.org/zh-cn/" target="_blank" rel="noopener noreferrer">Egg<ExternalLinkIcon/></a>：2016 年，阿里巴巴研发了知名的 Egg.js 开源项目，号称企业级 Web 服务框架。Egg.js 是基于 Koa 开发的。</p>
</li>
<li>
...
<h3 id="_3-7-总结" tabindex="-1"><a class="header-anchor" href="#_3-7-总结" aria-hidden="true">#</a> 3.7 总结</h3>
...
<h2 id="_4-node-js-的特点" tabindex="-1"><a class="header-anchor" href="#_4-node-js-的特点" aria-hidden="true">#</a> 4.Node.js 的特点</h2>
<ul>
<li>异步、非阻塞 IO 模型</li>
<li>事件循环</li>
<li>单线程</li>
...
<h2 id="_5-使用-node-js-时的劣势" tabindex="-1"><a class="header-anchor" href="#_5-使用-node-js-时的劣势" aria-hidden="true">#</a> 5.使用 Node.js 时的劣势</h2>
<ul>
