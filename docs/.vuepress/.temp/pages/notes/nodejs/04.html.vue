<template><div><h1 id="_04-【nodejs模块化规范-commonjs】" tabindex="-1"><a class="header-anchor" href="#_04-【nodejs模块化规范-commonjs】" aria-hidden="true">#</a> 04 【nodejs模块化规范：CommonJS】</h1>
...
<h2 id="_2-模块化的理解" tabindex="-1"><a class="header-anchor" href="#_2-模块化的理解" aria-hidden="true">#</a> 2.模块化的理解</h2>
<h3 id="_2-1-什么是模块化" tabindex="-1"><a class="header-anchor" href="#_2-1-什么是模块化" aria-hidden="true">#</a> 2.1 什么是模块化</h3>
...
<h3 id="_2-2-模块化的好处" tabindex="-1"><a class="header-anchor" href="#_2-2-模块化的好处" aria-hidden="true">#</a> 2.2 模块化的好处</h3>
<ul>
...
<h2 id="_3-模块化规范" tabindex="-1"><a class="header-anchor" href="#_3-模块化规范" aria-hidden="true">#</a> 3.模块化规范</h2>
<h3 id="_3-1-模块化规范的引入" tabindex="-1"><a class="header-anchor" href="#_3-1-模块化规范的引入" aria-hidden="true">#</a> 3.1 模块化规范的引入</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>但是这样做会带来很多问题：</p>
<ul>
...
<p>于是，这就引入了模块化规范。</p>
<h3 id="_3-2-模块化的概念解读" tabindex="-1"><a class="header-anchor" href="#_3-2-模块化的概念解读" aria-hidden="true">#</a> 3.2 模块化的概念解读</h3>
...
<h3 id="_3-3-模块化规范" tabindex="-1"><a class="header-anchor" href="#_3-3-模块化规范" aria-hidden="true">#</a> 3.3 模块化规范</h3>
<p>服务器端规范：</p>
<ul>
<li><a href="http://www.commonjs.org/" target="_blank" rel="noopener noreferrer"><strong>CommonJS规范</strong><ExternalLinkIcon/></a>：是 Node.js 使用的模块化规范。</li>
</ul>
<p>CommonJS 就是一套约定标准，不是技术。用于约定我们的代码应该是怎样的一种结构。</p>
<p>浏览器端规范：</p>
<ul>
<li><a href="https://github.com/amdjs/amdjs-api" target="_blank" rel="noopener noreferrer"><strong>AMD规范</strong><ExternalLinkIcon/></a>：是 <strong><a href="http://requirejs.org/" target="_blank" rel="noopener noreferrer">RequireJS<ExternalLinkIcon/></a></strong> 在推广过程中对模块化定义的规范化产出。</li>
</ul>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>- 异步加载模块；

- 依赖前置、提前执行：require([`foo`,`bar`],function(foo,bar){});   //也就是说把所有的包都 require 成功，再继续执行代码。

- define 定义模块：define([`require`,`foo`],function(){return});
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul>
<li><strong><a href="https://web.qianguyihao.com/11-Node.js/04-Node.js%E6%A8%A1%E5%9D%97%E5%8C%96%E8%A7%84%E8%8C%83%EF%BC%9ACommonJS.html" target="_blank" rel="noopener noreferrer">CMD规范<ExternalLinkIcon/></a></strong>：是 <strong><a href="http://seajs.org/" target="_blank" rel="noopener noreferrer">SeaJS<ExternalLinkIcon/></a></strong> 在推广过程中对模块化定义的规范化产出。淘宝团队开发。</li>
</ul>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>  同步加载模块；

  依赖就近，延迟执行：require(./a) 直接引入。或者Require.async 异步引入。   //依赖就近：执行到这一部分的时候，再去加载对应的文件。

  define 定义模块， export 导出：define(function(require, export, module){});
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>PS：面试时，经常会问AMD 和 CMD 的区别。</p>
<p>另外，还有ES6规范：import &amp; export。</p>
<p>这篇文章，我们来讲一下<code v-pre>CommonJS</code>，它是 Node.js 使用的模块化规范。</p>
<h2 id="_4-commonjs-的基本语法" tabindex="-1"><a class="header-anchor" href="#_4-commonjs-的基本语法" aria-hidden="true">#</a> 4.CommonJS 的基本语法</h2>
<h3 id="_4-1-commonjs-的介绍" tabindex="-1"><a class="header-anchor" href="#_4-1-commonjs-的介绍" aria-hidden="true">#</a> 4.1 CommonJS 的介绍</h3>
<p><a href="http://www.commonjs.org/" target="_blank" rel="noopener noreferrer">CommonJS<ExternalLinkIcon/></a>：是 Node.js 使用的模块化规范。也就是说，Node.js 就是基于 CommonJS 这种模块化规范来编写的。</p>
...
<li>在浏览器端: 模块需要提前编译打包处理。首先，既然同步的，很容易引起阻塞；其次，浏览器不认识<code v-pre>require</code>语法，因此，需要提前编译打包。</li>
</ul>
<h3 id="_4-2-模块的暴露和引入" tabindex="-1"><a class="header-anchor" href="#_4-2-模块的暴露和引入" aria-hidden="true">#</a> 4.2 模块的暴露和引入</h3>
<h3 id="_4-3-模块的暴露和引入" tabindex="-1"><a class="header-anchor" href="#_4-3-模块的暴露和引入" aria-hidden="true">#</a> 4.3 模块的暴露和引入</h3>
...
<h4 id="_4-3-1-暴露模块的方式一-exports" tabindex="-1"><a class="header-anchor" href="#_4-3-1-暴露模块的方式一-exports" aria-hidden="true">#</a> 4.3.1 暴露模块的方式一： exports</h4>
<p><code v-pre>exports</code>对象用来导出当前模块的公共方法或属性。别的模块通过 require 函数调用当前模块时，得到的就是当前模块的 exports 对象。</p>
<p><strong>语法格式</strong>：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 相当于是：给 exports 对象添加属性</span>
exports<span class="token punctuation">.</span>xxx <span class="token operator">=</span> value
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>这个 value 可以是任意的数据类型。</p>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> name <span class="token operator">=</span> <span class="token string">'qianguyihao'</span><span class="token punctuation">;</span>
...
<p>语法格式：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 方式一：导出整个 exports 对象</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这个 value 可以是任意的数据类型。</p>
<p>代码举例：</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-4-exports-和-module-exports-的区别" tabindex="-1"><a class="header-anchor" href="#_4-4-exports-和-module-exports-的区别" aria-hidden="true">#</a> 4.4 exports 和 module.exports 的区别</h3>
<p>最重要的区别：</p>
<ul>
<li>使用exports时，只能单个设置属性 <code v-pre>exports.a = a;</code></li>
<li>使用module.exports时，既单个设置属性 <code v-pre>module.exports.a</code>，也可以整个赋值 <code v-pre>module.exports = obj</code>。</li>
</ul>
<p>其他要点：</p>
<ul>
<li>Node中每个模块的最后，都会执行 <code v-pre>return: module.exports</code>。</li>
<li>Node中每个模块都会把 <code v-pre>module.exports</code>指向的对象赋值给一个变量 <code v-pre>exports</code>，也就是说 <code v-pre>exports = module.exports</code>。</li>
<li><code v-pre>module.exports = XXX</code>，表示当前模块导出一个单一成员，结果就是XXX。</li>
<li>如果需要导出多个成员，则必须使用 <code v-pre>exports.add = XXX; exports.foo = XXX</code>。或者使用 <code v-pre>module.exports.add = XXX; module.export.foo = XXX</code>。</li>
</ul>
<h3 id="_4-5-问题-暴露的模块到底是谁" tabindex="-1"><a class="header-anchor" href="#_4-5-问题-暴露的模块到底是谁" aria-hidden="true">#</a> 4.5 问题: 暴露的模块到底是谁？</h3>
...
<h3 id="_4-6-引入模块的方式-require" tabindex="-1"><a class="header-anchor" href="#_4-6-引入模块的方式-require" aria-hidden="true">#</a> 4.6 引入模块的方式：require</h3>
<p>require函数用来在一个模块中引入另外一个模块。传入模块名，返回模块导出对象。</p>
<p><strong>语法格式</strong>：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> module1 <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">'模块名'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<li>自定义模块：require的是<strong>文件路径</strong>。文件路径既可以用绝对路径，也可以用相对路径。后缀名<code v-pre>.js</code>可以省略。</li>
</ul>
<p><strong>代码举例</strong>：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>require()函数的两个作用</strong>：</p>
<ul>
<li>执行导入的模块中的代码。</li>
<li>返回导入模块中的接口对象。</li>
</ul>
<h3 id="_4-7-主模块" tabindex="-1"><a class="header-anchor" href="#_4-7-主模块" aria-hidden="true">#</a> 4.7 主模块</h3>
<p>主模块是整个程序执行的入口，可以调度其他模块。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 运行main.js启动程序。此时，main.js就是主模块</span>
$ <span class="token function">node</span> main.js
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-8-模块的初始化" tabindex="-1"><a class="header-anchor" href="#_4-8-模块的初始化" aria-hidden="true">#</a> 4.8 模块的初始化</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>（2）main.js：（在 main.js 中引入 hello.js 模块）</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> addModule1 <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">'./calModule'</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在命令行执行 <code v-pre>node main.js</code> 运行程序，打印结果：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token number">2</span>
<span class="token number">3</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>从打印结果中可以看出，<code v-pre>calModule.js</code>这个模块虽然被引用了两次，但只初始化了一次。</p>
<h2 id="_5-commonjs-在服务器端的实现举例" tabindex="-1"><a class="header-anchor" href="#_5-commonjs-在服务器端的实现举例" aria-hidden="true">#</a> 5.commonjs-在服务器端的实现举例</h2>
<p>（1）module1.js：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//暴露方式一：module.exports = value</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>注意，此时暴露出去的 exports 对象 等价于整个函数。</p>
<p>（3）module3.js：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//暴露方式二：exports.xxx = value</span>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//将其他模块汇集到主模块</span>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>我是 module1
我是 module2
module3 中的 foo1 方法
module3 中的 foo2 方法
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_6-commonjs-基于浏览器端的实现举例" tabindex="-1"><a class="header-anchor" href="#_6-commonjs-基于浏览器端的实现举例" aria-hidden="true">#</a> 6.commonjs-基于浏览器端的实现举例</h2>
<h3 id="_6-1-初始化项目" tabindex="-1"><a class="header-anchor" href="#_6-1-初始化项目" aria-hidden="true">#</a> 6.1 初始化项目</h3>
<p>在工程文件中新建如下目录和文件：</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>js
    dist //打包生成文件的目录
    src //源码所在的目录
      | module1.js
      | module2.js
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后在根目录下新建如下命令：</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>  npm init
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>然后根据提示，依次输入如下内容：</p>
<ul>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_6-2-下载第三方包-browserify" tabindex="-1"><a class="header-anchor" href="#_6-2-下载第三方包-browserify" aria-hidden="true">#</a> 6.2 下载第三方包：Browserify</h3>
<p>这里需要用到<a href="http://browserify.org/" target="_blank" rel="noopener noreferrer">Browserify<ExternalLinkIcon/></a>这个工具进行编译打包。Browserify 称为 CommonJS 的浏览器端的打包工具。</p>
<p>输入如下命令进行安装：（两个命令都要输入）</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>    npm install browserify <span class="token operator">-</span>g          <span class="token comment">//全局</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>上面的代码中，<code v-pre>-dev</code>表示开发依赖。这里解释一下相关概念：</p>
<ul>
<li>开发依赖：当前这个包，只在开发环境下使用。</li>
<li>运行依赖：当前这个包，是在生产环境下使用。</li>
</ul>
<h3 id="_6-3-自定义模块-代码运行" tabindex="-1"><a class="header-anchor" href="#_6-3-自定义模块-代码运行" aria-hidden="true">#</a> 6.3 自定义模块 &amp; 代码运行</h3>
<p>（1）module1.js：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">//暴露方式一：module.exports = value</span>
...
<p>打包处理js:</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>    browserify js/src/app.js -o js/dist/bundle.js
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>然后在index.html中引入打包后的文件：</p>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code>    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span> <span class="token attr-name">type</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>text/javascript<span class="token punctuation">"</span></span> <span class="token attr-name">src</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>js/dist/bundle.js<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token script"></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>script</span><span class="token punctuation">></span></span>
