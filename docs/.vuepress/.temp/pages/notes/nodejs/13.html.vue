<template><div><h1 id="_13-【操作mysql数据库】" tabindex="-1"><a class="header-anchor" href="#_13-【操作mysql数据库】" aria-hidden="true">#</a> 13 【操作mysql数据库】</h1>
<h2 id="_1-mysql-介绍" tabindex="-1"><a class="header-anchor" href="#_1-mysql-介绍" aria-hidden="true">#</a> 1.mysql 介绍</h2>
<p>付费的商用数据库：</p>
<ul>
<li>Oracle，典型的高富帅；</li>
...
<p><img src="https://i0.hdslb.com/bfs/album/8fc1c58bb05d52c4afa0641a099c92d078a55789.png" alt="image-20220420083146539"></p>
<h2 id="_2-与非关系数据库区别" tabindex="-1"><a class="header-anchor" href="#_2-与非关系数据库区别" aria-hidden="true">#</a> 2.与非关系数据库区别</h2>
...
<p><strong>关系型数据库最典型的数据结构是表，由二维表及其之间的联系所组成的一个数据组织</strong>
优点：
1、易于维护：都是使用表结构，格式一致；
...
2、固定的表结构，灵活度稍欠；
3、高并发读写需求，传统关系型数据库来说，硬盘I/O是一个很大的瓶颈。</p>
<p><strong>非关系型数据库严格上不是一种数据库，应该是一种数据结构化存储方法的集合，可以是文档或者键值对等。</strong></p>
<p>优点：</p>
<p>1、格式灵活：存储数据的格式可以是key,value形式、文档形式、图片形式等等，文档形式、图片形式等等，使用灵活，应用场景广泛，而关系型数据库则只支持基础类型。
2、速度快：nosql可以使用硬盘或者随机存储器作为载体，而关系型数据库只能使用硬盘；
3、高扩展性；
4、成本低：nosql数据库部署简单，基本都是开源软件。</p>
<p>缺点：</p>
<p>1、不提供sql支持；
2、无事务处理；
3、数据结构相对复杂，复杂查询方面稍欠。</p>
<h2 id="_3-mysql2的历史以及选择原因" tabindex="-1"><a class="header-anchor" href="#_3-mysql2的历史以及选择原因" aria-hidden="true">#</a> 3.MySQL2的历史以及选择原因</h2>
<p>MySQL2 项目是 <a href="https://github.com/sidorares/nodejs-mysql-native" target="_blank" rel="noopener noreferrer">MySQL-Native<ExternalLinkIcon/></a> 的延续。 协议解析器代码从头开始重写，api 更改为匹配流行的 <a href="https://github.com/mysqljs/mysql" target="_blank" rel="noopener noreferrer">mysqljs/mysql<ExternalLinkIcon/></a>。 MySQL2 团队正在与 <a href="https://github.com/mysqljs/mysql" target="_blank" rel="noopener noreferrer">mysqljs/mysql<ExternalLinkIcon/></a> 团队合作，将共享代码分解并移至 <a href="https://github.com/mysqljs/mysql" target="_blank" rel="noopener noreferrer">mysqljs<ExternalLinkIcon/></a> 组织下。</p>
<p>MySQL2 大部分 API 与 <a href="https://github.com/mysqljs/mysql" target="_blank" rel="noopener noreferrer">mysqljs<ExternalLinkIcon/></a> 兼容，并支持大部分功能。 MySQL2 还提供了更多的附加功能</p>
<ul>
<li>更快、更好的性能</li>
<li><a href="https://github.com/sidorares/node-mysql2/tree/master/documentation/Prepared-Statements.md" target="_blank" rel="noopener noreferrer">支持预处理<ExternalLinkIcon/></a></li>
<li>MySQL二进制日志协议</li>
<li><a href="https://github.com/sidorares/node-mysql2/tree/master/documentation/MySQL-Server.md" target="_blank" rel="noopener noreferrer">MySQL Server<ExternalLinkIcon/></a></li>
<li>对编码和排序规则有很好的支持</li>
<li><a href="https://github.com/sidorares/node-mysql2/tree/master/documentation/Promise-Wrapper.md" target="_blank" rel="noopener noreferrer">Promise封装<ExternalLinkIcon/></a></li>
<li>支持压缩</li>
<li>SSL 和 <a href="https://github.com/sidorares/node-mysql2/tree/master/documentation/Authentication-Switch.md" target="_blank" rel="noopener noreferrer">Authentication Switch<ExternalLinkIcon/></a></li>
<li><a href="https://github.com/sidorares/node-mysql2/tree/master/documentation/Extras.md" target="_blank" rel="noopener noreferrer">自定义流<ExternalLinkIcon/></a></li>
<li><a href="https://github.com/sidorares/node-mysql2/tree/master/documentation_zh-cn#using-connection-pools" target="_blank" rel="noopener noreferrer">连接池<ExternalLinkIcon/></a></li>
</ul>
<p>MySQL2 可以跨平台使用，毫无疑问可以安装在 Linux、Mac OS 或 Windows 上。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">npm</span> <span class="token function">install</span> <span class="token parameter variable">--save</span> mysql2
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_4-连接数据库" tabindex="-1"><a class="header-anchor" href="#_4-连接数据库" aria-hidden="true">#</a> 4.连接数据库</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5-查询" tabindex="-1"><a class="header-anchor" href="#_5-查询" aria-hidden="true">#</a> 5.查询</h2>
<ul>
<li>导入mysql</li>
<li>通过createPool方法将mysql数据库连接到服务器，并声明一个db变量</li>
<li>通过db.query方法测试是否连接成功</li>
<li>将数据返回给客户端
<ul>
<li>导入express</li>
<li>创建服务器</li>
<li>启动服务器</li>
<li>注册路由</li>
<li>通过db.query（查询数据库）来执行sql语句</li>
<li>如果执行成功将数据响应给客户端</li>
</ul>
</li>
</ul>
...
<p><img src="https://i0.hdslb.com/bfs/album/8ab5e75aff0d880a7842e5c9faff295ff16936f8.png" alt="image-20221105230812798"></p>
<p>返回的数据：</p>
<p><img src="https://i0.hdslb.com/bfs/album/2b34f7577230de56f5d481588c7758ea024d53f4.png" alt="image-20221105230828022"></p>
<h2 id="_6-插入" tabindex="-1"><a class="header-anchor" href="#_6-插入" aria-hidden="true">#</a> 6.插入</h2>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 给user中添加用户名和密码</span>
...
<p><img src="https://i0.hdslb.com/bfs/album/e881a7c9d4663f1f81817f0a4d899a0428c67b64.png" alt="image-20221105231625375"></p>
<h2 id="_7-修改" tabindex="-1"><a class="header-anchor" href="#_7-修改" aria-hidden="true">#</a> 7.修改</h2>
...
<p><img src="https://i0.hdslb.com/bfs/album/be9866defbe7223d33530db79638606752fc3b9f.png" alt="image-20221106095506641"></p>
<h2 id="_8-删除" tabindex="-1"><a class="header-anchor" href="#_8-删除" aria-hidden="true">#</a> 8.删除</h2>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 删除数据</span>
...
<p><img src="https://i0.hdslb.com/bfs/album/45f7756833e7a6b94fe54c92ae3c350e12614d92.png" alt="image-20221106100105915"></p>
</div></template>
