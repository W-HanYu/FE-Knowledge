<template><div><h1 id="_01-【vue简介-初识vue-模板语法和数据绑定】" tabindex="-1"><a class="header-anchor" href="#_01-【vue简介-初识vue-模板语法和数据绑定】" aria-hidden="true">#</a> 01 【Vue简介 初识Vue 模板语法和数据绑定】</h1>
<h2 id="_1-vue简介" tabindex="-1"><a class="header-anchor" href="#_1-vue简介" aria-hidden="true">#</a> 1.Vue简介</h2>
<h3 id="_1-1官网" tabindex="-1"><a class="header-anchor" href="#_1-1官网" aria-hidden="true">#</a> 1.1官网</h3>
<ul>
<li><a href="https://vuejs.org/" target="_blank" rel="noopener noreferrer">英文官网<ExternalLinkIcon/></a></li>
<li><a href="https://cn.vuejs.org/" target="_blank" rel="noopener noreferrer">中文官网<ExternalLinkIcon/></a></li>
</ul>
<h3 id="_1-2介绍与描述" tabindex="-1"><a class="header-anchor" href="#_1-2介绍与描述" aria-hidden="true">#</a> 1.2介绍与描述</h3>
<ul>
...
<p><img src="https://i0.hdslb.com/bfs/album/a480928cc5819344850462e511b11481f773c4e3.png" alt="image-20220627111824089"></p>
<h3 id="_1-3-vue-的特点" tabindex="-1"><a class="header-anchor" href="#_1-3-vue-的特点" aria-hidden="true">#</a> 1.3. Vue 的特点</h3>
<p>1 遵循MVVM模式
2 编码简洁，体积小，运行效率高，适合移动/PC端开发
3 它本身只关注 UI，可以引入其它第三方库开发项目
4采用<code v-pre>组件化</code>模式，提高代码复用率、且让代码更好维护</p>
<p><img src="https://i0.hdslb.com/bfs/album/911d5825fb775e5d72a180e14cf91cd4150b7d6f.png" alt="image-20220627112112058"></p>
<p>5 <code v-pre>声明式</code>编码，让编码人员无需直接操作DOM，提高开发效率</p>
<p><img src="https://i0.hdslb.com/bfs/album/84f52ac120ac699f8e9e2d5b777359e90545dd3a.png" alt="image-20220627112141707"></p>
<p>使用<code v-pre>虚拟DOM</code> 和 <code v-pre>Diff算法</code>，尽量复用DOM节点</p>
<p><img src="https://i0.hdslb.com/bfs/album/a28b2b5307e90c92fd36bbad151869b7dbc481ce.png" alt="image-20220627112235934"></p>
<h3 id="_1-4与其他-js-框架的关联" tabindex="-1"><a class="header-anchor" href="#_1-4与其他-js-框架的关联" aria-hidden="true">#</a> 1.4与其他 JS 框架的关联</h3>
<ul>
<li>借鉴 angular 的 <strong>模板</strong> 和 <strong>数据绑定</strong> 技术</li>
<li>借鉴 react 的 <strong>组件化</strong> 和 <strong>虚拟DOM</strong> 技术</li>
</ul>
<h3 id="_1-5vue-周边库" tabindex="-1"><a class="header-anchor" href="#_1-5vue-周边库" aria-hidden="true">#</a> 1.5Vue 周边库</h3>
<ul>
...
<h2 id="_2-初识vue" tabindex="-1"><a class="header-anchor" href="#_2-初识vue" aria-hidden="true">#</a> 2.初识Vue</h2>
<p><strong>前置工作</strong></p>
<ol>
<li>给浏览器安装 <a href="https://cn.vuejs.org/v2/guide/installation.html#Vue-Devtools" target="_blank" rel="noopener noreferrer">Vue Devtools<ExternalLinkIcon/></a> 插件</li>
<li>标签引入Vue包</li>
<li>（可选）阻止vue在启动时生成生产提示<code v-pre>Vue.config.productionTip = false</code></li>
...
<li>Vue 实例与容器是<code v-pre>一一对应</code>的</li>
<li>真实开发中只有一个Vue实例，并且会配合着组件一起使用</li>
<li><code v-pre>{{xxx}}</code>中的 xxx 要写<code v-pre> js 表达式</code>，且 xxx 可以自动读取到data中的所有属性
<strong>注意区分</strong>：js 表达式 和 js代码（语句）
<ol>
<li>表达式：一个表达式会产生一个值，可以放在任何一个需要值的地方
a	a+b		demo(1)		x === y ? 'a' : 'b'</li>
<li>js代码（语句）
if(){}		for(){}</li>
</ol>
</li>
...
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code>    <span class="token comment">&lt;!-- 引入Vue --></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-模板语法和数据绑定" tabindex="-1"><a class="header-anchor" href="#_3-模板语法和数据绑定" aria-hidden="true">#</a> 3.模板语法和数据绑定</h2>
<h3 id="_3-1模板语法" tabindex="-1"><a class="header-anchor" href="#_3-1模板语法" aria-hidden="true">#</a> 3.1模板语法</h3>
<p><code v-pre>Vue</code>模板语法有2大类:</p>
<ul>
<li>
<p><strong>插值语法：</strong></p>
<p>功能：用于解析标签体内容</p>
<p>写法：<code v-pre>{{xxx}}</code>，xxx是<strong>js表达式</strong>，且可以直接读取到data中的所有属性</p>
</li>
<li>
<p><strong>指令语法:</strong></p>
<p>功能：用于解析标签（包括：标签属性、标签体内容、绑定事件.....）</p>
<p>举例：<code v-pre>v-bind:href=&quot;xxx&quot;</code> 或  简写为 <code v-pre>:href=&quot;xxx&quot;</code>，xxx同样要写<code v-pre>js表达式</code>，且可以直接读取到data中的所有属性</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://i0.hdslb.com/bfs/album/39acee45f25c6e31959ae833c1f9d55cb08bc896.png" alt="image-20220627113847858"></p>
<h3 id="_3-2数据绑定" tabindex="-1"><a class="header-anchor" href="#_3-2数据绑定" aria-hidden="true">#</a> 3.2数据绑定</h3>
<p>Vue中有2种数据绑定的方式：</p>
<ul>
<li>
<p>单向绑定<code v-pre>(v-bind)</code>：数据只能从data流向页面</p>
</li>
<li>
<p>双向绑定<code v-pre>(v-model)</code>：数据不仅能从data流向页面，还可以从页面流向data</p>
<blockquote>
<p>tips:</p>
<p>1.双向绑定一般都应用在<strong>表单类元素</strong>上（如：<code v-pre>input</code>、<code v-pre>select</code>等）</p>
<p>2.<strong>v-model:value</strong> 可以简写为<code v-pre> v-model</code>，因为v-model默认收集的就是value值</p>
</blockquote>
</li>
</ul>
<blockquote>
