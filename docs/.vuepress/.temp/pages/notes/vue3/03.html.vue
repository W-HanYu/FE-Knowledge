<template><div><h1 id="_03-【响应式原理-ref和reactive总结-setup注意点】" tabindex="-1"><a class="header-anchor" href="#_03-【响应式原理-ref和reactive总结-setup注意点】" aria-hidden="true">#</a> 03 【响应式原理 ref和reactive总结 setup注意点】</h1>
<h2 id="_1-vue3-0中的响应式原理" tabindex="-1"><a class="header-anchor" href="#_1-vue3-0中的响应式原理" aria-hidden="true">#</a> 1.Vue3.0中的响应式原理</h2>
<h3 id="_1-1-vue2-x的响应式" tabindex="-1"><a class="header-anchor" href="#_1-1-vue2-x的响应式" aria-hidden="true">#</a> 1.1 vue2.x的响应式</h3>
<ul>
<li>
<p>实现原理：</p>
<ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-2-vue3-0的响应式" tabindex="-1"><a class="header-anchor" href="#_1-2-vue3-0的响应式" aria-hidden="true">#</a> 1.2 Vue3.0的响应式</h3>
<ul>
<li>
<p>实现原理:</p>
<ul>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>      <span class="token comment">//源数据</span>
	<span class="token keyword">const</span> person <span class="token operator">=</span> <span class="token punctuation">{</span>
      ...
      <span class="token keyword">const</span> p <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Proxy</span><span class="token punctuation">(</span>person<span class="token punctuation">,</span> <span class="token punctuation">{</span>
        ...
        <span class="token punctuation">}</span><span class="token punctuation">,</span>
      <span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://i0.hdslb.com/bfs/album/5ee7fa21dea8a952a76ba8342b02918ee943fa43.png" alt="image-20220705120849166"></p>
</li>
<li>
...
<blockquote>
<p>通过Reflect操作的属性，报错时会返回false，这样就不要try-catch捕获异常了。</p>
</blockquote>
<h2 id="_2-ref和reactive总结" tabindex="-1"><a class="header-anchor" href="#_2-ref和reactive总结" aria-hidden="true">#</a> 2.ref和reactive总结</h2>
<h3 id="_2-1-reactive对比ref" tabindex="-1"><a class="header-anchor" href="#_2-1-reactive对比ref" aria-hidden="true">#</a> 2.1 reactive对比ref</h3>
<ul>
<li>从定义数据角度对比：
<ul>
<li>ref用来定义：<strong style="color:#DD5145">基本类型数据</strong>。</li>
<li>reactive用来定义：<strong style="color:#DD5145">对象（或数组）类型数据</strong>。</li>
<li>备注：ref也可以用来定义<strong style="color:#DD5145">对象（或数组）类型数据</strong>, 它内部会自动通过<code v-pre>reactive</code>转为<strong style="color:#DD5145">代理对象</strong>。</li>
</ul>
</li>
<li>从原理角度对比：
<ul>
...
<h3 id="_2-2-ref" tabindex="-1"><a class="header-anchor" href="#_2-2-ref" aria-hidden="true">#</a> 2.2 ref</h3>
<p>1.<code v-pre>ref</code>通常用于声明<strong>基础类型响应式数据</strong>。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2.<code v-pre>ref</code>返回的是被包装过的响应式对象，<strong>在<code v-pre>setup</code>中访问和修改<code v-pre>ref</code>需要使用<code v-pre>.value</code>属性</strong></p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>age<span class="token punctuation">.</span>value<span class="token operator">=</span><span class="token number">21</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>3.在模板中使用时无需使用<code v-pre>.value</code>，直接使用即可</p>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span><span class="token punctuation">></span></span>{{age}}<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>4.当<code v-pre>ref</code>数据作为<code v-pre>props</code>传递给子组件的时候，<strong>在子组件里需要使用<code v-pre>toRef</code>或者<code v-pre>toRefs</code>建立引用，否则数据不是响应式的</strong>。且需要注意，如果在子组件中直接操作了这个引用之后，则和父组件不在具有联系。</p>
<h3 id="_2-3-reactive" tabindex="-1"><a class="header-anchor" href="#_2-3-reactive" aria-hidden="true">#</a> 2.3 reactive</h3>
<p>1.<code v-pre>reactive</code>用于声明<strong>复杂类型响应式数据</strong>。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2.<code v-pre>reactive</code>返回的是被包装过的响应式对象，<strong>在<code v-pre>setup</code>中访问和修改直接使用属性即可</strong></p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>man<span class="token punctuation">.</span>age<span class="token operator">=</span><span class="token number">20</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>3.<strong>声明时未定义，动态添加的属性也会是响应式的</strong></p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>man<span class="token punctuation">.</span>weight <span class="token operator">=</span> <span class="token string">'50kg'</span> <span class="token comment">//weight具有响应性</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>4.在模板中使用属性的形式</p>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span><span class="token punctuation">></span></span>{{man.name}}<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>5.将<code v-pre>reactive</code>声明的响应式数据传递给子组件时，在子组件可以直接使用。</p>
<p>1.当<code v-pre>ref</code>的值是数组时，我们可以通过索引来修改数组值是响应式的。</p>
<h3 id="_2-4-注意事项" tabindex="-1"><a class="header-anchor" href="#_2-4-注意事项" aria-hidden="true">#</a> 2.4 注意事项</h3>
<p>1.注意当<code v-pre>ref</code>用于在模板中作为真值判断时，直接使用<code v-pre>ref</code>恒为<code v-pre>true</code>, 需要使用<code v-pre>.value</code>才能正确显示</p>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">v-if</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>age<span class="token punctuation">"</span></span><span class="token punctuation">></span></span><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">></span></span> //恒为true
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>2.注意<strong>不能解构<code v-pre>reactive</code>数据</strong>，解构出的数据会失去响应式。</p>
<p>3.在任何地方访问响应式数据都能拿到最新的。</p>
<p>4.<strong>同<code v-pre>vue2</code>的<code v-pre>data</code>，只有数据被应用到模板中时，数据的改变才会触发<code v-pre>updated</code>生命周期</strong>，否则即使数据被修改了，也不会触发<code v-pre>updated</code>生命周期，导致视图不更新。</p>
<p>5.同<code v-pre>vue2</code>，当将<code v-pre>ref</code>和<code v-pre>reactive</code>作为<code v-pre>props</code>传递给组件时，原则上不应该在子组件上修改<code v-pre>props</code>的值。</p>
<h2 id="_3-setup的两个注意点" tabindex="-1"><a class="header-anchor" href="#_3-setup的两个注意点" aria-hidden="true">#</a> 3.setup的两个注意点</h2>
<ul>
<li>setup执行的时机
<ul>
...
<li>context：上下文对象
<ul>
<li>attrs: 值为对象，包含：组件外部传递过来，但没有在props配置中声明的属性, 相当于 <code v-pre>this.$attrs</code>。
如果子组件没有使用<code v-pre>props:[‘xxx’]</code>接收，attr这个对象就能看到父组件传来的数据</li>
<li>slots: 收到的插槽内容, 相当于 <code v-pre>this.$slots</code>。</li>
<li>emit: 分发自定义事件的函数, 相当于 <code v-pre>this.$emit</code>。
一定要在配置里写<code v-pre>emits:['hello']</code>, 这里要写父组件的自定义函数名称，不然会有警告</li>
</ul>
</li>
</ul>
</li>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>Demo.vue</code></p>
<div class="language-vue line-numbers-mode" data-ext="vue"><pre v-pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">></span></span>
