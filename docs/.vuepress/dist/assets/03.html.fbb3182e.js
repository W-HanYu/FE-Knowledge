import{_ as n,o as s,c as a,e}from"./app.7e6683dd.js";const p={},t=e(`<h1 id="_3-流程控制语句" tabindex="-1"><a class="header-anchor" href="#_3-流程控制语句" aria-hidden="true">#</a> 3.流程控制语句</h1><h2 id="_3-1-基本介绍" tabindex="-1"><a class="header-anchor" href="#_3-1-基本介绍" aria-hidden="true">#</a> 3.1 基本介绍</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code> <span class="token operator">*</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-2-if-条件分支语句" tabindex="-1"><a class="header-anchor" href="#_3-2-if-条件分支语句" aria-hidden="true">#</a> 3.2 if(条件分支语句)</h2><p>条件判断语句也称为if语句<br> 语法一：</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">if</span><span class="token punctuation">(</span>条件表达式<span class="token punctuation">)</span><span class="token punctuation">{</span>  
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>条件语句可以嵌套（最好不要嵌套超过三层）</li><li>if-elseif-else 语句注意条件的区间（下一级条件的成立是建立在上一级条件不成立的条件下）</li><li>可以只有 if 和 else if</li></ul><h2 id="_3-3-switch-条件分支语句" tabindex="-1"><a class="header-anchor" href="#_3-3-switch-条件分支语句" aria-hidden="true">#</a> 3.3 switch(条件分支语句)</h2><p>switch语句<br> 语法:</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">switch</span> <span class="token punctuation">(</span>变量<span class="token operator">/</span>表达式<span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
1
*/</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-8-初识算法" tabindex="-1"><a class="header-anchor" href="#_3-8-初识算法" aria-hidden="true">#</a> 3.8 初识算法</h2><p>算法：解决方案的准确而完整的描述！</p><ul><li>输入</li><li>输出</li><li>有穷性</li><li>确定性</li><li>可行性</li></ul><blockquote><p>好的算法还要满足：可读性、健壮性！</p></blockquote>`,54),o=[t];function i(l,c){return s(),a("div",null,o)}const u=n(p,[["render",i],["__file","03.html.vue"]]);export{u as default};
